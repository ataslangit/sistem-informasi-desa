...
class Master_keluarga extends BaseController
{
    ...
    public function sub_analisis_keluarga($id = '')
    {
    ...
    public function sub_analisis_keluarga_form($id = '')
    {
        if ($id) {
    ...
    public function sub_analisis_keluarga_list($id = '')
    {
        $header = $this->header_model->get_data();
        $this->load->view('header', $header);
    ...
    public function sub_analisis_keluarga_update($id = '')
    {
        $data['sub_analisis_keluarga'] = $this->master_analisis_keluarga_model->get_data_sub($id);
        $idmaster                      = $data['sub_analisis_keluarga']['id_master'];
