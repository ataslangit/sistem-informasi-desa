...
class Analisis_respon_penduduk_model extends Model
{
    ...
    public function update_kuisioner($id = 0)
    {
        $per   = $this->get_aktif_periode();
        $id_rb = $_POST['rb'];
        $id_cb = $_POST['cb'];
    ...
    public function list_jawab3($id = 0, $in = 0)
    {
        $per   = $this->get_aktif_periode();
    ...
    public function get_analisis_respon_penduduk($id = 0)
    {
