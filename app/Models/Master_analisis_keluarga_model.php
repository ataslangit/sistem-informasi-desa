...
class Master_analisis_keluarga_model extends Model
{
    ...
    public function get_data_sub($id = 0)
    {
    ...
    public function list_data_sub($id = 0)
    {
    ...
    public function delete_sub($id = 0)
    {
        $this->db->where('id', $id);
    ...
    public function insert_subx($id = 0)
    {
        $data              = $_POST;
        $data['id_master'] = $id;
    ...
    public function insert_sub($id = 0)
    {
        $sub   = $_POST['sub'];
        $nilai = $_POST['nilai'];
        //$data['id_master'] = $id;
    ...
    public function locking($id = 0, $val = 0)
    {
        $this->db->where('id', $id);
        $data['aktif'] = $val;
        $outp          = $this->db->update('master_analisis_keluarga', $data);
