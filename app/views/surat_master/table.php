			...
			<div class="ui-layout-north panel">
				<div class="left">
					<div class="uibutton-group">
						<a href="<?php echo site_url('surat_master/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus">&nbsp;</span>Tambah Surat Baru</a>
						<button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?php echo site_url("surat_master/delete_all/$p/$o")?>')" class="uibutton tipsy south"><span class="fa fa-trash-o">&nbsp;</span>Hapus Data
					</div>
				</div>
					<div class="right">
			...
			<div class="ui-layout-center" id="maincontent" style="padding: 5px;">
					...
					<?php foreach($main as $data): ?>
							<tr>
								...
								<td>
									<div class="uibutton-group">
										<a href="<?php echo site_url("surat_master/form/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="fa fa-pencil"> Ubah </span></a>
										<a href="<?php echo site_url("surat_master/delete/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash-o"></span></a>
										...
										<a href="<?php echo site_url("surat_master/favorit/$data[id]/$data[favorit]")?>" class="uibutton" target="confirm" message="Ubah Surat <?php echo $data['nama']?> dalam daftar surat Favorit?" header="Favorit" rel="window"><span class="<?php if($data['favorit']==1){?>fa fa-star-o <?php }else{?>fa fa-star <?php }?>"></span></a>
								...
								<td>
									<div class="uibutton-group">
										...
										<a href="<?php echo base_url("surat/$data[url_surat]/$data[url_surat].rtf")?>" class="uibutton tipsy south" title="Upload Template"><span class="fa fa-download"> Download </span></a>
										<?php } ?>
