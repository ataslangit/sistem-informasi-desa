...
class Laporan_keluarga extends BaseController
{
    ...
    public function detail($stat = 0, $jwb = 0, $thn = '', $bln = '', $lap = 0, $p = 1, $o = 0)
    {
        $data['p']    = $p;
        $data['o']    = $o;
        $data['stat'] = $stat;
    ...
    public function lap_detail_a($p = 1, $o = 0)
    {
        $data['p'] = $p;
        $data['o'] = $o;
    ...
    public function lap_detail_b($p = 1, $o = 0)
    {
        $data['p'] = $p;
        $data['o'] = $o;
    ...
    public function jawaban($id = '', $id2 = '')
    {
        $data['config']              = $this->analisis_laporan_keluarga_model->get_config();
    ...
    public function dusun($stat = '', $jwb = '', $thn = '', $bln = '', $lap = '', $p = '', $o = '')
    {
        $data['p']    = $p;
        $data['o']    = $o;
        $data['stat'] = $stat;
    ...
    public function rw($stat = '', $jwb = '', $thn = '', $bln = '', $lap = '', $p = '', $o = '')
    {
        $data['p']    = $p;
        $data['o']    = $o;
        $data['stat'] = $stat;
    ...
    public function rt($stat = '', $jwb = '', $thn = '', $bln = '', $lap = '', $p = '', $o = '')
    {
        $data['p']    = $p;
        $data['o']    = $o;
        $data['stat'] = $stat;
    ...
    public function cetak_detail($stat = 0, $jwb = 0, $thn = '', $bln = '', $lap = 0, $p = 1, $o = 0)
    {
        $data['p']    = $p;
        $data['o']    = $o;
        $data['stat'] = $stat;
    ...
    public function rentang_analisis()
    {
        //$data['lap']=13;
        $data['jenis']      = $_SESSION['jenis'];
    ...
    public function detail_rentang($id = 0)
    {
        $data['id'] = $id;
    ...
    public function dusun_rentang($id = 0)
    {
        $data['id'] = $id;
        $dusun      = $this->input->post('dusun');
        if ($dusun !== '') {
    ...
    public function rw_rentang($id = 0)
    {
        $data['id'] = $id;
        $rw         = $this->input->post('rw');
        if ($rw !== '') {
    ...
    public function rt_rentang($id = 0)
    {
        $data['id'] = $id;
        $rt         = $this->input->post('rt');
        if ($rt !== '') {
    ...
    public function detail_rentang_cetak($id = 0)
    {
        $data['id'] = $id;
