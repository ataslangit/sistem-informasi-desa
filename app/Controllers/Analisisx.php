...
class Analisisx extends BaseController
{
    ...
    public function keluarga($p = 1, $o = 0)
    {
        $data['p'] = $p;
        $data['o'] = $o;
    ...
    public function ajax_update_klasifikasi($p = 1, $o = 0)
    {
    ...
    public function update_klasifikasi($p = 1, $o = 0)
    {
        $this->analisis_model->update_klasifikasi();
        redirect('analisis');
    }

    public function rincian($p = 1, $o = 0, $id = '')
    {
        if (isset($_SESSION['jenis'])) {
            $data['jenis'] = $_SESSION['jenis'];
        } else {
    ...
    public function graph_rincian($id = '')
    {
        $data['kk']                  = $this->analisis_model->get_keluarga($id);
        $data['kepala']              = $this->analisis_model->get_anggota($data['kk']['nik_kepala']);
        $data['form_action']         = site_url("analisis/insert/{$id}");
    ...
    public function bar_rincian($id = '')
    {
        $data['kk']                  = $this->analisis_model->get_keluarga($id);
        $data['kepala']              = $this->analisis_model->get_anggota($data['kk']['nik_kepala']);
        $data['form_action']         = site_url("analisis/insert/{$id}");
    ...
    public function rentang_search()
    {
        ...
        if ($rentang1) {
            ...
            unset($_SESSION['rentang1']);
        }
        if ($rentang2) {
            $_SESSION['rentang2'] = $rentang2;
        } else {
            unset($_SESSION['rentang2']);
        }
        $this->analisis_model->update_klasifikasi();
        redirect('analisis');
    }

    public function ajax_rentang_search()
    {
    ...
    public function clear_analisis_all()
    {
        $this->analisis_model->clear_analisis_all();
        redirect('analisis');
    }

    public function clear_analisis($id = '')
    {
    ...
    public function delete_all_rentang($id = 0)
    {
        $this->analisis_model->delete_all_rentang();
        redirect('analisis/rentang_analisis');
    }

    public function jenis_analisis()
    {
        //$data['lap']=13;
    ...
    public function form_jenis($id = 0)
    {
        if ($id === 0) {
    ...
    public function jenis_update($id = 0)
    {
        $this->analisis_model->update_jenis($id);
        redirect('analisis/jenis_analisis');
    }

    public function jenis_delete($id = 0)
    {
        $this->analisis_model->delete_jenis($id);
        redirect('analisis/jenis_analisis');
    }

    public function delete_all_jenis($id = 0)
    {
    ...
    public function ubah_hasil_klasifikasi($id = 0)
    {
    ...
    public function hasil_klasifikasi_update($id = 0)
    {
        $this->analisis_model->update_hasil_klasifikasi($id);
        redirect('analisis');
    }

    public function verifikasi($p = 1, $o = 0)
    {
        $data['p']      = $p;
        $data['o']      = $o;
        $data['paging'] = $this->analisis_model->pagingx($p, $o);
