                        ...
                        <div class="ui-layout-north panel">
                            <div class="left">
                                <div class="uibutton-group">
                                    <a href="<?= site_url('man_user/form') ?>" class="uibutton tipsy south" title="Tambah Data"><span class="icon-plus-sign icon-large">&nbsp;</span>Tambah Penguna Baru</a>
                            ...
                            <table class="list">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($o === 4) : ?>
                                            <th align="left"><a href="<?= site_url("man_user/index/{$p}/3") ?>">Nama Pengguna<span class="ui-icon ui-icon-triangle-1-n">&nbsp;</span></a></th>
                                        <?php elseif ($o === 3) : ?>
                                            <th align="left"><a href="<?= site_url("man_user/index/{$p}/4") ?>">Nama Pengguna<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
                                        <?php else : ?>
                                            <th align="left"><a href="<?= site_url("man_user/index/{$p}/3") ?>">Nama Pengguna<span class="ui-icon ui-icon-triangle-2-n-s">&nbsp;</span></a></th>
                                        <?php endif; ?>

                                        <?php if ($o === 6) : ?>
                                            <th align="left" width='100'><a href="<?= site_url("man_user/index/{$p}/5") ?>">Level<span class="ui-icon ui-icon-triangle-1-n">&nbsp;</span></a></th>
                                        <?php elseif ($o === 5) : ?>
                                            <th align="left" width='100'><a href="<?= site_url("man_user/index/{$p}/6") ?>">Level<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
                                        <?php else : ?>
                                            <th align="left" width='100'><a href="<?= site_url("man_user/index/{$p}/5") ?>">Level<span class="ui-icon ui-icon-triangle-2-n-s">&nbsp;</span></a></th>
                                        <?php endif; ?>
                                ...
                                <tbody>
                                    <?php foreach ($main as $data) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="uibutton-group">
                                                    <a href="<?= site_url("man_user/form/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Ubah Data"><span class="icon-edit icon-large"> Ubah </span></a>
                                                    <?php if ($data['username'] !== 'admin') { ?>
                                                        <a href="<?= site_url("man_user/delete/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="icon-trash icon-large"></span></a>
                                                        <?php if ($data['active'] === '0') : ?>
                                                            <a href="<?= site_url('man_user/user_unlock/' . $data['id']) ?>" class="uibutton tipsy south" title="Aktivasi User"><span class="icon-lock icon-large"></span></a>
                                                        <?php elseif ($data['active'] === '1') : ?><a href="<?= site_url('man_user/user_lock/' . $data['id']) ?>" class="uibutton tipsy south" title="Non-aktifkan User"><span class="icon-unlock icon-large"></span></a>
                                                        <?php endif; ?>
                                                    <?php } ?>
                                                </div>
                                            </td>
                        ...
                        <div class="right">
                            ...
                            <div class="uibutton-group">
                                ...
                                <?php for ($i = $paging->start_link; $i <= $paging->end_link; $i++) : ?>
                                    <a href="<?= site_url("man_user/index/{$i}/{$o}") ?>" <?php jecho($p, $i, "class='uibutton special'") ?> class="uibutton"><?= $i ?></a>
                                <?php endfor; ?>
                            </div>
                            <div class="uibutton-group">
                                <?php if ($paging->next) : ?>
