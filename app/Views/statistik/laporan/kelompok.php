                        ...
                        <div class="ui-layout-north panel top">
                            <div class="left">
                                <div class="uibutton-group">
                                    ...
                                    <a href="<?= site_url('laporan_rentan/excel') ?>" class="uibutton special tipsy south" title="Excel" target="_blank"><span class="ui-icon ui-icon-print">&nbsp;</span>Unduh</a>
                                </div>
                            </div>
                        </div>
                        <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
                            ...
                            <table width="100%"><?php foreach ($config as $data) { ?>
                                    <tbody>
                                        <tr>
                                            <td width="37%">
                                                <h4>PEMERINTAH KABUPATEN/KOTA <?= $data['nama_kabupaten'] ?></h4>
                                            </td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td width="100%">
                                                <h3>LAPORAN BULANAN KELURAHAN</h3>
                                            </td>
                                        ...
                                        <td>
                                            <select name="dusun" onchange="formAction('mainform','<?= site_url('laporan_rentan/dusun') ?>')">
                                                ...
                                                <?php foreach ($list_dusun as $data) { ?>
                                                    <option value="<?= $data['dusun'] ?>" <?php if ($dusun === $data['dusun']) { ?>selected<?php } ?>><?= ununderscore($data['dusun']) ?></option>
                                                <?php } ?>
                                            </select>
                                        </td>
                                        <td width="40%"></td>
                                        ...
                                        <th colspan="6" scope="col">
                                            <div align="center">
                                                <table width="100%">
                                                    ...
                                                    <tr>
                                                        <th>
                                                            <div align="center">Bayi(<1thn)< /div>
                                                        </th>
                                                        <th>
                                                            <div align="center">Balita(1-5thn)</div>
                                                        </th>
                                                        <th>
                                                            <div align="center">SD(6-12thn)</div>
                                                        </th>
                                                        <th>
                                                            <div align="center">SMP(13-15thn)</div>
                                                        </th>
                                                        <th>
                                                            <div align="center">SMA(16-18thn)</div>
                                                        </th>
                                                        <th>
                                                            <div align="center">Lansia(>60)</div>
                                                        </th>
                                                    </tr>
                                                </table>
                                            </div>
