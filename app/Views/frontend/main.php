        ...
        <div class="innertube">
            <div class="box box-danger">
                <div class="box-header with-border">
                    <h3 class="box-title"><a href="http://localhost:2772/first/artikel/34">Presiden RI Kunjungi Desa Bumi Pertiwi</a></h3>
                    <div class="pull-right small">, 01 Februari 2017 08:32:26 WIB</div>
                </div>
                <div class="box-body" style="text-align:justify;">
                    <a class="group2" href="http://localhost:2772/assets/files/artikel/sedang_14859379462017 02 - Contoh Foto SID 3.10.jpg" title="">
                        <img width="600" src="http://localhost:2772/assets/files/artikel/sedang_14859379462017 02 - Contoh Foto SID 3.10.jpg" /></a>
                            ...
                            <?php foreach ($artikel as $i => $pos) : ?>
                                <li class="artikel">
                                    ...
                                    <div class="teks" style="text-align:justify;">
                                        ...
                                        <div class="img">
                                            <img src="http://localhost:2772/assets/files/artikel/kecil_14864642872017 02 - Contoh Foto SID 3.10 c.jpg" alt="PKK Desa Bumi Pertiwi Raih Juara 1 Tingkat Kabupaten">
                                        </div>
