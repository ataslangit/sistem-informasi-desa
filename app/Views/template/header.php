    ...
    <div class="innertube">
            ...
            <div id="headercontent">
                ...
                <div id="menu_vert2">
                    ...
                    <script type="text/javascript">
                        ...
                        sts_ai("i2", [, , , , "kecil_14859374622017 02 - Contoh Foto SID 3.10 b.jpg", 146, 90, "center"], [], "i2", "i2");
                        sts_es();
                    </script>
        ...
        <div id="headleft">
            <div id="divlogo">
                <div id="divlogo-txt">
                    <div class="intube">
                        <div id="siteTitle">
                            <h1>Desa Bumi Pertiwi</h1>
                            <h2>Kecamatan Nusantara<br />
                                Kabupaten Sejahtera<br />
                                Provinsi Banjar Raya</h2>
        ...
        <div id="scroller">
            ...
            <ul id="ticker01" style="display:none;">
                <li> Selamat datang di website Desa Bumi Pertiwi. </li>
                <li> | </li>
                <li> Kantor Desa Bumi Pertiwi membuka pelayanan publik pada hari Senin - Sabtu pukul 08.00 - 15.00. </li>
                <li> | </li>
                </li>
            </ul>
        </div>
