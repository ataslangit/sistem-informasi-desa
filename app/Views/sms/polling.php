        ...
        foreach ($main as $data) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                ...
                                                <a href="<?= site_url("sms/form_polling/{$data['id_polling']}") ?>" class="ui-icons icon-edit tipsy south" title="Edit Data" target="ajax-modalx" rel="window" header="Edit Data"></a> <?php if ($data['jumlah_pertanyaan'] === '0') { ?>
                                                    <a href="<?= site_url("sms/polling_delete/{$data['id_polling']}") ?>" class="ui-icons icon-remove tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?php } ?>
                    ...
                    <div class="ui-layout-south panel bottom">
                        <div class="left">
                            <div class="table-info">
                                <?= form_open('sms/polling', ['id' => 'paging']) ?>
                        ...
                        <div class="right">
                            ...
                            <div class="uibutton-group">
                                ...
                                <?php for ($i = $paging->start_link; $i <= $paging->end_link; $i++) : ?>
                                    <a href="<?= site_url("sms/polling/{$i}/{$o}") ?>" <?php jecho($p, $i, "class='uibutton special'") ?> class="uibutton"><?= $i ?></a>
                                <?php endfor; ?>
                            </div>
                            <div class="uibutton-group">
                                <?php if ($paging->next) : ?>
