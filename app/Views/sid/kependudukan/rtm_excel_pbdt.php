...
<div id="body">
  ...
  height:12.0pt;width:808pt'>BLOK I. IDENTITAS WILAYAH SLS</td>
        ...
        <tr height=17 style='mso-height-source:userset;height:12.95pt'>
            ...
            <td class=xl76 width=13 style='width:10pt'><?= $config['kode_kabupaten'] ?></td>
            ...
            <td class=xl76 width=15 style='width:11pt'><?= $_SESSION['dusun'] ?></td>
            <td class=xl76 width=13 style='width:10pt'>&nbsp;</td>
        </tr>
        <tr height=18 style='mso-height-source:userset;height:14.1pt'>
            ...
            <td colspan=2 class=xl100 width=206 style='border-right:.5pt solid black; border-left:none;width:154pt'><?= strtoupper($config['nama_kecamatan']) ?></td>
            <td class=xl76 width=13 style='width:10pt'><?= $config['kode_kecamatan'] ?></td>
            <td class=xl76 width=13 style='width:10pt'>&nbsp;</td>
            <td class=xl76 width=13 style='width:10pt'>&nbsp;</td>
            ...
            <td class=xl76 width=100 style='width:75pt'>:</td>
            <td class=xl76 width=15 style='width:11pt'><?= $_SESSION['rt'] ?></td>
            <td class=xl76 width=13 style='width:10pt'><?= $_SESSION['rw'] ?></td>
        </tr>
        <tr height=18 style='mso-height-source:userset;height:14.1pt'>
            <td height=18 class=xl67 width=58 style='height:14.1pt;width:44pt'>3</td>
            <td class=xl68 width=189 style='width:142pt'>Desa</td>
            <td colspan=2 class=xl102 style='border-right:.5pt solid black;border-left: none'><?= strtoupper($config['nama_desa']) ?></td>
            <td class=xl76 width=13 style='width:10pt'><?= $config['kode_desa'] ?></td>
            <td class=xl76 width=13 style='width:10pt'>&nbsp;</td>
            <td class=xl76 width=13 style='width:10pt'>&nbsp;</td>
    ...
    <table border="1">
        ...
        <?php foreach ($main as $data) : ?>
            <tr>
                <td><?= $data['no_kk'] ?></td>
                <td colspan="2"><?= strtoupper($data['kepala_kk']) ?></td>
                <td colspan="2"><?php
