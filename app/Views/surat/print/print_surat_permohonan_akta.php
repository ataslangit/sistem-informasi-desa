            ...
            <div>
                ...
                <div id="isi3">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>Kabupaten <?= unpenetration($desa['nama_kabupaten']) ?></td>
                        </tr>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                    ...
                    <table width="100%">
                        ...
                        <td class="indentasi" colspan="4">Mengajukan permohonan untuk diterbitkan penetapan Pengadilan Negeri sebagai persyaratan pencatatan peristiwa kelahiran dan penerbitan kutipan Akta Kelahiran atas nama:</tr>
                            <tr>
                                <td>Nama</td>
                                <td>:</td>
                                <td><?= unpenetration($input['nama_anak']) ?> </td>
                            </tr>
                            <tr>
                                <td>Tempat dan Tanggal Lahir</td>
                                <td>:</td>
                                <td><?= $input['tempatlahir_anak'] ?>, <?= tgl_indo(tgl_indo_in($input['tanggallahir_anak'])) ?> </td>
                        </td>
                        </tr>
                        <tr>
                            <td>Hari Lahir</td>
                            <td>:</td>
                            <td><?= $input['harilahir_anak'] ?> </td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td>:</td>
                            <td><?= $input['alamat_anak'] ?> </td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                        <tr>
                        ...
                        <tr>
                            <td>Nama Ayah</td>
                            <td>:</td>
                            <td><?= unpenetration($input['nama_ayah']) ?> </td>
                        </tr>
                        <tr>
                            <td>Nama Ibu</td>
                            <td>:</td>
                            <td><?= unpenetration($input['nama_ibu']) ?> </td>
                        </tr>
                        <tr>
                            <td>Alamat Orang Tua</td>
                            <td>:</td>
                            <td><?= unpenetration($input['nama_ortu']) ?> </td>
                        </tr>
                    </table>
                    <table>
                        <tr></tr>
