                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="indentasi">Yang bertanda tangan dibawah ini <?= unpenetration($pamong['jabatan']) ?> <?= unpenetration($desa['nama_desa']) ?>, Kecamatan <?= unpenetration($desa['nama_kecamatan']) ?>,
                            Kabupaten <?= unpenetration($desa['nama_kabupaten']) ?>, Provinsi <?= unpenetration($desa['nama_propinsi']) ?> menerangkan bahwa: </td>
                    </tr>
                </table>
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            <td>Alamat</td>
                            <td>:</td>
                            <td>RT. <?= $data['rt'] ?>, RW. <?= $data['rw'] ?>, Dusun <?= ununderscore(unpenetration($data['dusun'])) ?>, Desa <?= unpenetration($desa['nama_desa']) ?>, Kec. <?= unpenetration($desa['nama_kecamatan']) ?>, Kab. <?= unpenetration($desa['nama_kabupaten']) ?></td>
                        </tr>
                        <tr>
                            <td>Alamat yang dituju</td>
                            <td>:</td>
                            <td>RT. <?= $input['rt_tujuan'] ?>, RW. <?= $input['rw_tujuan'] ?>, Kampung <?= $input['kampung_tujuan'] ?>, Dusun <?= ununderscore(unpenetration($input['dusun_tujuan'])) ?>, Desa <?= unpenetration($input['desa_tujuan']) ?>, Kec. <?= unpenetration($input['kecamatan_tujuan']) ?>, Kab. <?= unpenetration($input['kabupaten_tujuan']) ?></td>
                        </tr>
                        <tr>
                            <td>Alasan </td>
                            <td>:</td>
...
?>
                    ...
                    <tr>
                        <table width="100%">
                            ...
                            <tr></tr>
                            <tr>
                                <td>Surat keterangan ini diterbitkan sebagai <?= $input['keterangan'] ?>.</td>
                            </tr>
                            <tr></tr>
                            <tr></tr>
