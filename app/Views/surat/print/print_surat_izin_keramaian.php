                ...
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            <td>Keperluan </td>
                            <td>:</td>
                            <td> Sebagai pengantar untuk mendapatkan Surat Izin Keramaian berupa <?= $input['jenis_keramaian'] ?> mulai tanggal <?= tgl_indo(tgl_indo_in($input['berlaku_dari'])) ?> sampai dengan <?= tgl_indo(tgl_indo_in($input['berlaku_sampai'])) ?> dengan keperluan <?= $input['keperluan'] ?>. </td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr></tr>
