                                    ...
                                    <tr>
                                        ...
                                        <?php if ($o === 2) : ?>
                                            ...
                                            <?php if ($o === 4) : ?>
                                                ...
                                                <?php if ($o === 6) : ?>
                                                    <th align="left" width='150'><a href="<?= site_url("gallery/index/{$p}/5") ?>">Diunggah pada<span class="ui-icon ui-icon-triangle-1-n">
                                                            <?php elseif ($o === 5) : ?>
                                                    <th align="left" width='150'><a href="<?= site_url("gallery/index/{$p}/6") ?>">Diunggah pada<span class="ui-icon ui-icon-triangle-1-s">
                                                            <?php else : ?>
                                                    <th align="left" width='150'><a href="<?= site_url("gallery/index/{$p}/5") ?>">Diunggah pada<span class="ui-icon ui-icon-triangle-2-n-s">
                                                                <?php endif; ?>&nbsp;</span></a></th>
                                ...
                                <tbody>
                                    <?php foreach ($main as $data) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="uibutton-group">
                                                    <a href="<?= site_url("gallery/sub_gallery/{$data['id']}") ?>" class="uibutton tipsy south" title="Rincian Sub Gallery"><span class="icon-zoom-in icon-large"> Rincian </span></a>
                                                    <a href="<?= site_url("gallery/form/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Ubah Data"><span class="icon-edit icon-large"></span></a>
                                                    <?php if ($_SESSION['sesi'] < 4) { ?>
                                                        <a href="<?= site_url("gallery/delete/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="icon-trash icon-large"><span></a><?php if ($data['enabled'] === '2') : ?>
                                                            <a href="<?= site_url('gallery/gallery_lock/' . $data['id']) ?>" class="uibutton tipsy south" title="Aktivasi gallery"><span class="icon-lock icon-large"></span></a><?php elseif ($data['enabled'] === '1') : ?>
                                                            <a href="<?= site_url('gallery/gallery_unlock/' . $data['id']) ?>" class="uibutton tipsy south" title="Non-aktifkan gallery"><span class="icon-unlock icon-large"></span></a>
                                                        <?php endif ?>
                                                    <?php } ?>
                                                </div>
                        ...
                        <div class="right">
                            ...
                            <div class="uibutton-group">
                                ...
                                <?php for ($i = $paging->start_link; $i <= $paging->end_link; $i++) : ?>
                                    <a href="<?= site_url("gallery/index/{$i}/{$o}") ?>" <?php jecho($p, $i, "class='uibutton special'") ?> class="uibutton"><?= $i ?></a>
                                <?php endfor; ?>
                            </div>
                            <div class="uibutton-group">
                                <?php if ($paging->next) : ?>
