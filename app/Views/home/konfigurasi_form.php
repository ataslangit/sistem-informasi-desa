<div id="pageC">
    <table class="inner">
        ...
        <tr>
            <th>Nama Provinsi</th>
            <td><input name="nama_propinsi" type="text" class="inputbox" size="25" value="<?php echo $main['nama_propinsi']?>"> Kode <input name="kode_propinsi" type="text" class="inputbox" size="10" value="<?php echo $main['kode_propinsi']?>"></td>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input name="gapi_key" type="text" class="inputbox" size="45" value="<?php echo $main['gapi_key']?>"><br> *) Kode unik yang didapatkan dari pendaftaran akun Google Maps. Klik di sini untuk petunjuk lebih jelas: <a target='_blank' href="https://developers.google.com/maps/documentation/javascript/get-api-key">Google API Key</a></td>
            </td>
        </tr>
    </table>
</div>
