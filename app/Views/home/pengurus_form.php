                        ...
                        <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
                            <table class="form">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="uiradio">
                                            <input type="radio" id="group1" name="pamong_status" value="1" <?php if ($pamong !== null && ($pamong['pamong_status'] == '1' or $pamong['pamong_status'] == '')) { echo 'checked'; } ?>>
                                            <label for="group1">Aktif</label>
                                            <input type="radio" id="group2" name="pamong_status" value="2" <?php if ($pamong !== null && ($pamong['pamong_status'] == '2')) { echo 'checked'; } ?>>
