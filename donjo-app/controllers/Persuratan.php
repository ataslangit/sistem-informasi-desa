...
class Persuratan extends BaseController
{
    ...
    public function index()
    {
        ...
        view('persuratan/nav', $nav);
        view('persuratan/format_surat', $data);
        view('footer');
    }
    ...
    public function form($url = '')
    {
        ...
        $data['form_action']  = site_url("persuratan/cetak/{$url}");
        $data['form_action2'] = site_url("persuratan/doc/{$url}");
        $nav['act']           = 1;
        $header               = $this->header_model->get_data();

        view('header', $header);
        view('persuratan/nav', $nav);
        view("persuratan/form/{$url}", $data);
        view('footer');
    }
    ...
    public function cetak($url = '')
    {
        ...
        view('persuratan/print/print_' . $url . '', $data);
    }
