...
<form method="post" action="<?php echo $form_action?>">
    ...
    <table>
        <tr>
            <td>Nama</td>
            <td><input class="inputbox2" name="cari" type="text" size="40"></td>
        </tr>
        <tr>
            <td>Umur</td>
            <td><input class="inputbox2" name="umur_min" type="text" size="5"> - <input class="inputbox2" name="umur_max" type="text" size="5"></td>
        </tr>
        <tr>
            <td>Dusun</td>
