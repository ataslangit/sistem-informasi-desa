...
<?php  if ($_SESSION['grup'] === 1 || $_SESSION['grup'] === 2) {?>
	...
	<li><a href="<?= site_url()?>/penduduk"><i class="icon-group icon-large"></i>Penduduk</a></li>
	...
	<li><a href="<?= site_url()?>/program_bantuan"><i class="icon-folder-open icon-large"></i>Program</a></li>
<?php  }?>
<?php  if ($_SESSION['grup'] === 1 || $_SESSION['grup'] === 2) {?>
...
<div class="module-panel">
	<div class="contentm" style="overflow: hidden;">
		...
		<a class="cpanel" href="<?= site_url()?>/penduduk/clear">
		...
		<a class="cpanel" href="<?= site_url()?>/data_persil/clear" title="Data Persil">
		...
		<?php if ($_SESSION['grup'] === 1 || $_SESSION['grup'] === 2) {?>
		<a class="cpanel" href="<?= site_url()?>/lapor">
			<img src="<?= base_url()?>assets/images/cpanel/mail-reply-all.png" alt=""/>
			<span><b><?= $lapor; ?></b> Laporan</span>
		</a>
		<?php }?>
	</div>
</div>
