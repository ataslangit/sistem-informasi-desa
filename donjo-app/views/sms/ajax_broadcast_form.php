...
<form action="<?php echo $form_action?>" method="post" id="validasi">
    ...
    <table>
        <tr>
            <td>Umur</td>
            <td><input class="inputbox2" name="umur_min1" type="text" size="5"> - <input class="inputbox2" name="umur_max1" type="text" size="5"></td>
        </tr>
        <tr>
            <td>Dusun</td>
        ...
        <tr>
            <td width="100">Isi Pesan</td>
            <td><textarea name="TextDecoded1" class=" required" style="resize: none; height:100px; width:250px;" size="300" maxlength='160'></textarea></td>
        </tr>
    </table>
