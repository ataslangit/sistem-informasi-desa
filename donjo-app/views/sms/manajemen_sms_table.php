                            ...
                            <table class="list">
                                <thead>
                                    <tr>
                                        ...
                                        <?php elseif ($o === 1) : ?>
                                            <th align="left" width='100'><a href="<?= site_url("sms/index/{$p}/2") ?>">Nomor HP<span class="ui-icon ui-icon-triangle-1-s"></span></a></th <?php else : ?> <th align="left" width='100'><a href="<?= site_url("sms/index/{$p}/1") ?>">Nomor HP<span class="ui-icon ui-icon-triangle-2-n-s"></span></a></th>
                                        <?php endif; ?>
                        ...
                        <div class="right">
                            ...
                            <div class="uibutton-group">
                                ...
                                <?php for ($i = $paging->start_link; $i <= $paging->end_link; $i++) : ?>
                                    <a href="<?= site_url("sms/index/{$i}/{$o}") ?>" <?php jecho($p, $i, "class='uibutton special'") ?> class="uibutton"><?= $i ?></a>
                                <?php endfor; ?>
                            </div>
                            <div class="uibutton-group">
                                <?php if ($paging->next) : ?>
