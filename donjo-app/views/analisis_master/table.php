    ...
    <h3>Modul Analisis</h3>
        <div class="left">
            <div class="uibutton-group">
                ...
                <a href="<?= site_url('analisis_master/import_analisis')?>" class="uibutton special tipsy south" title="Import" ><span class="icon-plus icon-large">&nbsp;</span>Import Analisis</a>
            </div>
        </div>
    </div>
