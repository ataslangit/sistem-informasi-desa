...
if (isset($_session['mandiri'])) {
    if ($_SESSION['mandiri'] !== 1) {
		...
		<div class="box box-primary box-solid">
			...
			<div class="box-body">
				<h4>Gagal 3 kali, silahkan coba kembali dalam <?= waktu_ind((time() - $_SESSION['mandiri_timeout']) * (-1)); ?> detik lagi</h4>
				<div id="note">
...
<div class="box box-info box-solid">
	<div class="box-header">
		<h3 class="box-title"><a href="<?= site_url('first/statistik/1') ?>"><i class="fa fa-bar-chart"></i> Statistik <?= $desa['nama_desa']; ?></a></h3>
	</div>
	<div class="box-body">
