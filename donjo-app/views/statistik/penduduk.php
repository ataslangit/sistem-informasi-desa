	...
	<td class="side-menu">
		...
		<legend>Statistik Penduduk</legend>
			<div id="sidecontent2" class="lmenu">
				<ul>
				<a href="<?= site_url()?>/statistik/index/13"><li <?php if ($lap === 13) {?>class="selected"<?php }?>>
					Umur</li></a>
				<a href="<?= site_url()?>/statistik/index/0"><li <?php if ($lap === 0) {?>class="selected"<?php }?>>
					Pendidikan dalam KK</li></a>
				<a href="<?= site_url()?>/statistik/index/14"><li <?php if ($lap === 14) {?>class="selected"<?php }?>>
					Pendidikan sedang Ditempuh</a></li>
				<a href="<?= site_url()?>/statistik/index/1"><li <?php if ($lap === 1) {?>class="selected"<?php }?>>
					Pekerjaan</li></a>
				<a href="<?= site_url()?>/statistik/index/2"><li <?php if ($lap === 2) {?>class="selected"<?php }?>>
					Status Perkawinan</li></a>
				<a href="<?= site_url()?>/statistik/index/3"><li <?php if ($lap === 3) {?>class="selected"<?php }?>>
					Agama</li></a>
				<a href="<?= site_url()?>/statistik/index/4"><li <?php if ($lap === 4) {?>class="selected"<?php }?>>
					Jenis Kelamin</li></a>
				<a href="<?= site_url()?>/statistik/index/5"><li <?php if ($lap === 5) {?>class="selected"<?php }?>>
					Warga Negara</li></a>
				<a href="<?= site_url()?>/statistik/index/6"><li <?php if ($lap === 6) {?>class="selected"<?php }?>>
					Status Penduduk</li></a>
				<a href="<?= site_url()?>/statistik/index/7"><li <?php if ($lap === 7) {?>class="selected"<?php }?>>
					Golongan Darah</li></a>
				<a href="<?= site_url()?>/statistik/index/9"><li <?php if ($lap === 9) {?>class="selected"<?php }?>>
					Penyandang Cacat</li></a>
				<?php /*<a href="<?php echo site_url()?>/statistik/index/10"><li <?php if($lap==10){?>class="selected"<?php }?>>
                    Sakit Menahun</li></a>	*/?>
				<a href="<?= site_url()?>/statistik/index/11"><li <?php if ($lap === 11) {?>class="selected"<?php }?>>
       ...
       <table class="list">
		<thead>
            <tr>
	 		...
	 		<?php  if ($o === 2): ?>
				<th width="250" align="left"><a href="<?= site_url("statistik/index/{$lap}/1")?>">Jenis Kelompok<span class="ui-icon ui-icon-triangle-1-n">&nbsp;</span></a></th>
			<?php  elseif ($o === 1): ?>
				<th width="250" align="left"><a href="<?= site_url("statistik/index/{$lap}/2")?>">Jenis Kelompok<span class="ui-icon ui-icon-triangle-1-s">&nbsp;</span></a></th>
			<?php  else: ?>
				<th width="250" align="left"><a href="<?= site_url("statistik/index/{$lap}/1")?>">Jenis Kelompok<span class="ui-icon ui-icon-triangle-2-n-s">&nbsp;</span></a></th>
			<?php  endif; ?>
