                    ...
                    <div>
                        <?= form_open_multipart($form_action, ['id' => 'mainform']) ?>
                            <table>
                                <tr>
                                    <td>Berkas DK :</td>
                                    <td><input type="file" name="file_dk" id="file_dk" /></td>
                                </tr>
                                <tr>
                                    <td>Berkas BW :</td>
                                    <td><input type="file" name="file_bw" id="file_bw" /></td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <a onclick="formAction('mainform','<?= $form_action ?>')" class="uibutton special" target="confirm2" message="Proses Import Sedang Berlangsung!!!" header="Harap Tunggu"> Import </a>
                                    </td>
                                </tr>
                            </table>
                        <?= form_close() ?>
