...
*/ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url("penduduk/ajax_penduduk_maps/{$p}/{$o}/{$penduduk['id']}") ?>" target="ajax-modalz" rel="window<?= $penduduk['id'] ?>" header="Lokasi <?= $penduduk['nama'] ?>" class="uibutton special" title="Lokasi <?= $penduduk['nama'] ?>">Edit Lokasi</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url("penduduk/dokumen/{$penduduk['id']}") ?>" class="uibutton confirm">Manajemen Dokumen</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </table>
