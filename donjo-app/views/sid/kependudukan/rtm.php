                        ...
                        <div class="ui-layout-north panel">
                            ...
                            <div class="left">
                                <div class="uibutton-group">
                                    ...
                                    <a href="<?= site_url("rtm/cetak/{$o}") ?>" target="_blank" class="uibutton tipsy south" title="Cetak"><span class="icon-print icon-large">&nbsp;</span>Cetak</a>
                                ...
                                <tbody>
                                    <?php foreach ($main as $data) : ?>
                                        <tr>
                                            ...
                                            <td width="5">
                                                <div class="uibutton-group">
                                                    <a href="<?= site_url("rtm/anggota/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Rincian Anggota Rumah Tangga"><span class="icon-list icon-large"> Rincian </span></a>
                                                    <?php if ($grup === 1) { ?><a href="<?= site_url("rtm/edit_nokk/{$p}/{$o}/{$data['id']}") ?>" target="ajax-modal" rel="window" header="Edit Rumah Tangga" class="uibutton tipsy south" title="Edit Data"><span class="icon-edit icon-large"></span></a><a href="<?= site_url("rtm/delete/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda yakin?" header="Hapus Data"><span class="icon-trash icon-large"></span> </a><?php } ?>
                                                </div>
                                            </td>
