...
<!--				<a href="<?php //=site_url("rtm/sosial/")?>" class="uibutton confirm" title="Grafik Kelas Sosial" ><span class="icon-bar-chart icon-large">&nbsp;</span>Grafik Kelas Sosial</a>
    ...
    <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
        ...
        <?php  if ($grup === 1) {?><a href="<?= site_url("rtm/delete/{$p}/{$o}/{$data['id']}")?>"  class="uibutton tipsy south"  title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span  class="icon-trash icon-large"></span> </a><?php  } ?>
		</div> </td>
