    ...
    <table class="inner">
        <tr style="vertical-align:top">
            <td style="background:#fff;padding:0px;">
                ...
                <div id="contentpane">
                    <?= form_open('', ['id' => 'mainform', 'name' => 'mainform'], ['rt' => '']) ?>
                    <div class="ui-layout-north panel">
                        <div class="left">
                            <div class="uibutton-group">
                                <a href="<?= site_url('penduduk/form') ?>" class="uibutton tipsy south" title="Tambah Data"><span class="icon-plus-sign icon-large">&nbsp;</span>Penduduk Domisili</a>

                                <?php if ($grup === 1) { ?>
                                    <button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?= site_url("penduduk/delete_all/{$p}/{$o}") ?>')" class="uibutton chrome"><span class="icon-trash icon-large">&nbsp;</span>Hapus Data</button>
                                <?php } ?>
                                ...
                                <a href="<?= site_url('penduduk/excel/' . $o) ?>" class="uibutton tipsy south" title="Unduh" target="_blank"><span class="icon-file-text icon-large">&nbsp;</span>Unduh</a>
                        ...
                        <div class="left">
                            ...
                            <select name="status_dasar" onchange="formAction('mainform','<?= site_url('penduduk/status_dasar') ?>')">
                            ...
                            <a href="<?= site_url('penduduk/ajax_adv_search') ?>" target="ajax-modalx" rel="window" header="Pencarian Spesifik" class="uibutton tipsy south" title="Pencarian Spesifik"><span class="icon-search icon-large">&nbsp;</span>Pencarian Spesifik</a>
                            <a href="<?= site_url('penduduk/clear') ?>" class="uibutton tipsy south" title="Bersihkan Pencarian"><span class="icon-refresh icon-large">&nbsp;</span>Bersihkan</a>
                        </div>
                        <div class="right">
                            ...
                            <a href="<?= site_url('penduduk/duplikat') ?>" class="uibutton tipsy south" title="Cari Duplikat"><span class="icon-copy icon-large">&nbsp;</span></a>
                        </div>
                    </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="100" align="left">
                                        <?php if ($o === 6) : ?>
                                            <a href="<?= site_url("penduduk/index/{$p}/5") ?>">Nomor KK<span class="ui-icon ui-icon-triangle-1-n">
                                        <?php elseif ($o === 5) : ?>
                                            <a href="<?= site_url("penduduk/index/{$p}/6") ?>">Nomor KK<span class="ui-icon ui-icon-triangle-1-s">
                                        <?php else : ?>
                                            <a href="<?= site_url("penduduk/index/{$p}/5") ?>">Nomor KK<span class="ui-icon ui-icon-triangle-2-n-s">
                                        <?php endif; ?>
                                        &nbsp;</span></a>
                                    </th>
                                    ...
                                    <th width="50" align="left">
                                        ...
                                        <?php else : ?>
                                            <a href="<?= site_url("penduduk/index/{$p}/7") ?>">Umur<span class="ui-icon ui-icon-triangle-2-n-s">
                                        <?php endif; ?>
                                        &nbsp;</span></a>
                                    </th>
                                    <th>Tanggal Lahir</th>
                                        ...
                                        <td>
                                            <div class="uibutton-group">
                                                ...
                                                <?php if ($data['status_dasar'] !== 3) { ?>
                                                    ...
                                                    <a href="<?= site_url("penduduk/edit_status_dasar/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Peristiwa Penting Kependudukan" target="ajax-modal" rel="window" header="Peristiwa Penting Kependudukan"><span class="icon-wrench icon-large"></span></a>
                                                    <a href="<?= site_url("penduduk/ajax_penduduk_pindah/{$data['id']}") ?>" class="uibutton tipsy south" title="Pindah Penduduk dalam Desa" target="ajax-modal" rel="window" header="Pindah Penduduk dalam Desa"><span class="icon-share icon-large"></span></a>
                                                <?php } ?>
                                                <?php if ($grup === 1) { ?><a href="<?= site_url("penduduk/delete/{$p}/{$o}/{$data['id']}") ?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" rel="window" header="Hapus Data"><span class="icon-trash icon-large"></span></a><?php } ?>
                                            </div>
                                        </td>
