                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="uibutton-group">
                                                    ...
                                                    <?php } ?>
                                                    <?php if ($grup == 1) { ?><a href="<?php echo site_url("penduduk/delete/$p/$o/$data[id]") ?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" rel="window" header="Hapus Data"><span class="icon-trash icon-large"></span></a><?php } ?>
                                                </div>
                                            </td>
