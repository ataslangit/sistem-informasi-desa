...
<!--
				<strong style="padding-left:20px;font-size:14px;"><?= $judul_statistik; ?></strong> <select name="agama" onchange="formAction('mainform','<?php //=site_url('penduduk/agama')?>')">
	...
	<thead>
		<tr>
			...
			<?php  else: ?><a href="<?= site_url("penduduk/index/{$p}/5")?>">No. KK<span class="ui-icon ui-icon-triangle-2-n-s">
			<?php  endif; ?>
			&nbsp;</span></a></th>
...
<?php  if ($grup === 1) {?><a href="<?= site_url("penduduk/delete/{$p}/{$o}/{$data['id']}")?>" class="uibutton tipsy south"  title="Hapus Data"  target="confirm" message="Apakah Anda Yakin?" rel="window" header="Hapus Data"><span class="icon-trash icon-large"></span></a><?php  }?></div>
</td>
