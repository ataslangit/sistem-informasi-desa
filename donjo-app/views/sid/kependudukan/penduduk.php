                        ...
                        <div class="ui-layout-north panel">
                            <div class="left">
                                <div class="uibutton-group">
                                    ...
                                    <?php if ($grup == 1) { ?><button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?=  site_url("penduduk/delete_all/$p/$o") ?>')" class="uibutton chrome"><span class="icon-trash icon-large">&nbsp;</span>Hapus Data</button><?php } ?>
                                                ...
                                                <a href="<?=  site_url("penduduk/index/$p/5") ?>">Nomor KK<span class="ui-icon ui-icon-triangle-1-n">
                                                    <?php elseif ($o == 5) : ?>
                                                        <a href="<?=  site_url("penduduk/index/$p/6") ?>">Nomor KK<span class="ui-icon ui-icon-triangle-1-s">
                                                            <?php else : ?><a href="<?=  site_url("penduduk/index/$p/5") ?>">Nomor KK<span class="ui-icon ui-icon-triangle-2-n-s">
                                                                    <?php endif; ?>
                                                                    &nbsp;</span></a>
                                        </th>
                                                ...
                                                <a href="<?=  site_url("penduduk/index/$p/7") ?>">Umur<span class="ui-icon ui-icon-triangle-1-n">
                                                    <?php elseif ($o == 7) : ?>
                                                        <a href="<?=  site_url("penduduk/index/$p/8") ?>">Umur<span class="ui-icon ui-icon-triangle-1-s">
                                                            <?php else : ?><a href="<?=  site_url("penduduk/index/$p/7") ?>">Umur<span class="ui-icon ui-icon-triangle-2-n-s">
                                                                    <?php endif; ?>
                                                                    &nbsp;</span></a>
                                        </th>
                                        <th>Tanggal Lahir</th>
