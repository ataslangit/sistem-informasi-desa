...
<tr>
	...
	<td>
	<div class="uiradio">
	<input type="radio" id="rs1" name="raskin" value="1"/<?php if ($kk['raskin'] === '1') {
    echo 'checked';
}?>>
	<label for="rs1">Ya</label>
	<input type="radio" id="rs2" name="raskin" value="2"/<?php if ($kk['raskin'] === '2' || $kk['raskin'] === '') {
    echo 'checked';
}?>>
...
<tr>
	...
	<td>
	<div class="uiradio">
	<input type="radio" id="rs1" name="id_blt" value="1"/<?php if ($kk['id_blt'] === '1') {
    echo 'checked';
}?>>
	<label for="rs1">Ya</label>
	<input type="radio" id="rs2" name="id_blt" value="2"/<?php if ($kk['id_blt'] === '2' || $kk['id_blt'] === '') {
    echo 'checked';
}?>>
	<label for="rs2">Tidak</label>
	</div>
...
<tr>
	...
	<td>
	<div class="uiradio">
	<input type="radio" id="rs1" name="id_pkh" value="1"/<?php if ($kk['id_pkh'] === '1') {
    echo 'checked';
}?>>
	<label for="rs1">Ya</label>
	<input type="radio" id="rs2" name="id_pkh" value="2"/<?php if ($kk['id_pkh'] === '2' || $kk['id_pkh'] === '') {
    echo 'checked';
}?>>
	<label for="rs2">Tidak</label>
	</div>
...
<tr>
	...
	<td>
	<div class="uiradio">
	<input type="radio" id="rs1" name="id_bedah_rumah" value="1"/<?php if ($kk['id_bedah_rumah'] === '1') {
    echo 'checked';
}?>>
	<label for="rs1">Ya</label>
	<input type="radio" id="rs2" name="id_bedah_rumah" value="2"/<?php if ($kk['id_bedah_rumah'] === '2' || $kk['id_bedah_rumah'] === '') {
    echo 'checked';
}?>>
	<label for="rs2">Tidak</label>
	</div>
