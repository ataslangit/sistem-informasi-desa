...
<a href="<?= site_url("rtm/anggota/{$p}/{$o}/{$id_kk}")?>" class="uibutton icon prev">Daftar Anggota</a>
</div>
 </div>
</div>
...
<div class="left">
<a href="<?= site_url()?>/rtm" class="uibutton icon prev">Kembali</a>
</div>
<div class="right">
<div class="uibutton-group">
<a href="<?= site_url("rtm/cetak_kk/{$id_kk}")?>" target="_blank" class="uibutton special">Cetak</a>
</div>
</div>
</div>
</form>
