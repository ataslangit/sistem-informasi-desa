                        ...
                        <div class="ui-layout-north panel">
                            ...
                            <div class="left">
                                <div class="uibutton-group">
                                    ...
                                    <a href="<?= site_url("sid_core/cetak_rt/{$id_dusun}/{$rw}") ?>" target="_blank" class="uibutton tipsy south" title="Cetak"><span class="icon-print icon-large">&nbsp;</span>Cetak</a>
                                    <a href="<?= site_url("sid_core/excel_rt/{$id_dusun}/{$rw}") ?>" target="_blank" class="uibutton tipsy south" title="Unduh"><span class="icon-file-text icon-large">&nbsp;</span>Unduh</a>
                                </div>
                            </div>
                        </div>
