                                ...
                                <tbody>
                                    <?php foreach ($main as $data) : ?>
                                        <tr>
                                            ...
                                            <td width="5">
                                                <?php if ($data['rt'] !== '-') { ?><a href="<?= site_url("sid_wilayah/form_rt/{$p}/{$o}/{$dusun}/{$rw}/{$data['rt']}") ?>" class="icon-edit icon-large" title="Edit Data"></a><a href="<?= site_url("sid_wilayah/delete_rt/{$p}/{$o}/{$dusun}/{$rw}/{$data['rt']}") ?>" class="icon-trash icon-large" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?php } ?>
                                            </td>
                                            <td><?= $data['rt'] ?></td>
