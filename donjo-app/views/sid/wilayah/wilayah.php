...
<div id="contentpane">
 ...
 <a href="<?php echo site_url('sid_core/form')?>" class="uibutton tipsy south" title="Tambah Data" ><span class="fa fa-plus">&nbsp;</span>Tambah Dusun</a>
 <a href="<?php echo site_url('sid_core/cetak')?>" target="_blank" class="uibutton tipsy south" title="Cetak" ><span class="fa fa-print">&nbsp;</span>Cetak</a>
		<a href="<?php echo site_url('sid_core/excel')?>" target="_blank" class="uibutton tipsy south" title="Unduh" ><span class="fa fa-download">&nbsp;</span>Unduh</a>
 </div>
 </div>
		<div class="right">
...
<a href="<?php echo site_url("sid_core/form/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data"><span class="fa fa-pencil"></span></a>
<?php if($grup==1){?>
