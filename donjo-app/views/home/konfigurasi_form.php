...
<div class="ui-layout-north panel"><h3>Pengaturan</h3>
 ...
 <form action="<?php echo site_url("admin/pengaturan_desa/update/$main[id]")?>" method="POST" enctype="multipart/form-data">
 ...
 <td>
	 <a href="<?php echo site_url("admin/pengaturan_desa/ajax_kantor_maps")?>" class="uibutton confirm" target="ajax-modalz" rel="window-lok" header="Lokasi <?php echo $main['nama_desa']?>" title="Lokasi <?php echo $main['nama_desa']?>">Kantor Desa</a><p class="kan" style="display:none;">*) data kantor desa telah diperbaharui, kliksimpan untuk melanjutkan...</p></br></br>
	 <a href="<?php echo site_url("admin/pengaturan_desa/ajax_wilayah_maps")?>" class="uibutton confirm" target="ajax-modalz" rel="window-wil" header="Wilayah <?php echo $main['nama_desa']?>" title="Wilayah <?php echo $main['nama_desa']?>">Wilayah Desa</a><p class="wil" style="display:none;">*) data wilayah telah diperbaharui, kliksimpan untuk melanjutkan...</p>
 </td>
 </tr>
 <tr>
