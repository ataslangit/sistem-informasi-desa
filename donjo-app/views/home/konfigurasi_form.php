...
<div class="ui-layout-north panel"><h3>Pengaturan</h3>
 ...
 <td><input name="nama_kecamatan" type="text" class="inputbox" size="25" value="<?= $main['nama_kecamatan']?>"/> Kode <input name="kode_kecamatan" type="text" class="inputbox" size="10" value="<?= $main['kode_kecamatan']?>"/></td></td>
 </tr>
 <tr>
 <th>Nama Camat</th>
 ...
 <td><input name="nama_kabupaten" type="text" class="inputbox" size="25" value="<?= $main['nama_kabupaten']?>"/> Kode <input name="kode_kabupaten" type="text" class="inputbox" size="10" value="<?= $main['kode_kabupaten']?>"/></td></td>
 </tr>
 <tr>
 <th>Nama Provinsi</th>
 <td><input name="nama_propinsi" type="text" class="inputbox" size="25" value="<?= $main['nama_propinsi']?>"/> Kode <input name="kode_propinsi" type="text" class="inputbox" size="10" value="<?= $main['kode_propinsi']?>"/></td></td>
 </tr>
 <tr>
 ...
 <td>
	 <a href="<?= site_url('hom_desa/ajax_kantor_maps')?>" class="uibutton confirm" target="ajax-modalz" rel="window-lok" header="Lokasi <?= $main['nama_desa']?>" title="Lokasi <?= $main['nama_desa']?>">Kantor Desa</a><p class="kan" style="display:none;">*) data kantor desa telah diperbaharui, kliksimpan untuk melanjutkan...</p></br></br>
	 <a href="<?= site_url('hom_desa/ajax_wilayah_maps')?>" class="uibutton confirm" target="ajax-modalz" rel="window-wil" header="Wilayah <?= $main['nama_desa']?>" title="Wilayah <?= $main['nama_desa']?>">Wilayah Desa</a><p class="wil" style="display:none;">*) data wilayah telah diperbaharui, kliksimpan untuk melanjutkan...</p>
 </td>
 </tr>
 <tr>
 <th>Google API Key</th>
 <td><input name="gapi_key" type="text" class="inputbox" size="45" value="<?= $main['gapi_key']?>"/><br /> *) Kode unik yang didapatkan dari pendaftaran akun Google Maps. Klik di sini untuk petunjuk lebih jelas: <a target='_blank' href="https://developers.google.com/maps/documentation/javascript/get-api-key">Google API Key</a></td></td>
 </tr>
 </table>
 </div>
