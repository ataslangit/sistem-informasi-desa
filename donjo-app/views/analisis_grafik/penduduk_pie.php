    ...
    <table class="inner">
        <tr style="vertical-align:top">
            <td class="side-menu">
                ...
                <div id="" class="lmenu">
                    <ul>
                        <a href="<?= site_url('statistik/index/21') ?>s">
                            <li <?php if ($lap === 21) { ?>class="selected" <?php } ?>>
                                Kelas Sosial</li>
                        </a>
                        <a href="<?= site_url('statistik/index/22') ?>">
                            <li <?php if ($lap === 22) { ?>class="selected" <?php } ?>>
                                Raskin</li>
                        </a>
                        <a href="<?= site_url('statistik/index/23') ?>">
                            <li <?php if ($lap === 23) { ?>class="selected" <?php } ?>>
                                BLSM</li>
                        </a>
                        <a href="<?= site_url('statistik/index/25') ?>">
                            <li <?php if ($lap === 25) { ?>class="selected" <?php } ?>>
                                PKH</li>
                        </a>
                        <a href="<?= site_url('statistik/index/27') ?>">
                ...
                <div id="sidecontent3" class="lmenu">
                    <ul>
                        ...
                        <a href="<?= site_url('statistik/index/10') ?>">
                            <li <?php if ($lap === 10) { ?>class="selected" <?php } ?>>
                                Sakit Menahun</li>
                        </a>
                        <a href="<?= site_url('statistik/index/11') ?>">
                            <li <?php if ($lap === 11) { ?>class="selected" <?php } ?>>
                                Jamkesmas</li>
                        </a>
                        <a href="<?= site_url('statistik/index/15') ?>">
