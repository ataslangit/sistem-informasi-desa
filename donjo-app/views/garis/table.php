...
<td>
<a href="<?= site_url("garis/form/{$p}/{$o}/{$data['id']}")?>" class="ui-icons icon-edit tipsy south" title="Edit Data"></a><a href="<?= site_url("garis/delete/{$p}/{$o}/{$data['id']}")?>" class="ui-icons icon-remove tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?php  /*if($data['enabled'] == '2'):?><a href="<?php  echo site_url('plan/garis/garis_lock/'.$data['id'])?>" class="ui-icons icon-lock tipsy south" title="Enable garis"></a><?php  elseif($data['enabled'] == '1'): ?><a href="<?php  echo site_url('plan/garis/garis_unlock/'.$data['id'])?>" class="ui-icons icon-unlock tipsy south" title="Disable garis"></a>*/?><a href="<?= site_url("garis/ajax_garis_maps/{$p}/{$o}/{$data['id']}")?>" target="ajax-modalz" rel="window" header="garis <?= $data['nama']?>" class="ui-icons icon-maps tipsy south" title="garis <?= $data['nama']?>"></a>
