                                ...
                                <tbody>
                                    <?php foreach ($main as $data) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= site_url("polygon/form/{$p}/{$o}/{$data['id']}") ?>" class="ui-icons icon-edit tipsy south" title="Edit Data"></a><a href="<?= site_url("polygon/delete/{$p}/{$o}/{$data['id']}") ?>" class="ui-icons icon-remove tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><?php if ($data['enabled'] === '2') : ?><a href="<?= site_url('polygon/polygon_lock/' . $data['id']) ?>" class="ui-icons icon-lock tipsy south" title="Enable polygon"></a><?php elseif ($data['enabled'] === '1') : ?><a href="<?= site_url('polygon/polygon_unlock/' . $data['id']) ?>" class="ui-icons icon-unlock tipsy south" title="Disable polygon"></a><a href="<?= site_url("polygon/sub_polygon/{$data['id']}") ?>" class="ui-icons icon-document-table tipsy south" title="Rincian Sub polygon"></a><a href="<?= site_url("polygon/ajax_add_sub_polygon/{$data['id']}") ?>" <?= $data['nama'] ?>" class="ui-icons icon-plus tipsy south" title="Tambah Sub polygon"></a>
                                                <?php endif ?>
                                            </td>
