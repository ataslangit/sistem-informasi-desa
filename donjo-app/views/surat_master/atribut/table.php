                        ...
                        <div class="ui-layout-north panel">
                            ...
                            <div class="left">
                                <div class="uibutton-group">
                                    <a href="<?= site_url("analisis_indikator/form_parameter/{$analisis_indikator['id']}") ?>" class="uibutton tipsy south" title="Tambah Data" target="ajax-modal" rel="window" header="Form Data Parameter"><span class="icon-plus-sign icon-large">&nbsp;</span>Tambah Parameter Baru</a>
