...
<?php  if ($o === 6): ?>
<th align="left" width='250'><a href="<?= site_url("web/index/{$p}/5")?>">Diposting Pada<span class="ui-icon ui-icon-triangle-1-n">
<?php  elseif ($o === 5): ?>
<th align="left" width='250'><a href="<?= site_url("web/index/{$p}/6")?>">Diposting Pada<span class="ui-icon ui-icon-triangle-1-s">
<?php  else: ?>
<th align="left" width='250'><a href="<?= site_url("web/index/{$p}/5")?>">Diposting Pada<span class="ui-icon ui-icon-triangle-2-n-s">
<?php  endif; ?>&nbsp;</span></a></th>
