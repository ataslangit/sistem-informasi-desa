            ...
            <div class="ui-layout-north panel">
                ...
                <div class="left">
                    <div class="uibutton-group">
                        <?php if ($analisis_master['lock'] === 1) { ?> <a href="<?= site_url("analisis_indikator/form_parameter/{$analisis_indikator['id']}") ?>" class="uibutton tipsy south" title="Tambah Data" target="ajax-modal" rel="window" header="Form Data Jawaban"><span class="icon-plus-sign icon-large">&nbsp;</span>Tambah Ukuran/Nilai Baru</a>
                            <button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?= site_url('analisis_indikator/p_delete_all_parameter]') ?>')" class="uibutton tipsy south"><span class="icon-trash icon-large">&nbsp;</span>Hapus Data<?php } ?>
                    </div>
                </div>
            </div>
