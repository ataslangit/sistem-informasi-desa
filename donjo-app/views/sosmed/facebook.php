<div id="pageC">
	...
	<td class="side-menu">
			<div class="lmenu">
				...
				<ul><a href="<?= site_url('sosmed/google')?>">
				<li>Google</li></a>
				</ul>
				<ul><a href="<?= site_url('sosmed/youtube')?>">
				<li>Youtube</li></a>
				</ul>
				<ul><a href="<?= site_url('sosmed/instagram')?>">
				<li>Instagram</li></a>
				</ul>
			</div>
...
<div id="contentpane">
 ...
 <table class="form">
		<tr>
			<td width="150">Link Akun Facebook</td><td><textarea name="link" class=" required" style="resize: none; height:100px; width:250px;" size="300" maxlength='160'><?php if ($main) {
    echo $main['link'];
} ?></textarea></td>
		</tr>
<tr>
