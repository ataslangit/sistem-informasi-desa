...
<tr><td>Alamat/ Tempat Tinggal</td><td>:</td><td>RW. <?= $data['rw']?>, RT. <?= $data['rt']?>, Dusun <?= unpenetration(ununderscore($data['dusun']))?>, Desa <?= unpenetration($desa['nama_desa'])?>, Kec. <?= unpenetration($desa['nama_kecamatan'])?>, Kab. <?= unpenetration($desa['nama_kabupaten'])?></td></tr>
...
<tr></tr>
<tr></tr>
<tr><td class="indentasi">Adalah benar-benar warga Desa <?= unpenetration($desa['nama_desa'])?> dan merupakan orang yang sama namun terdapat perbedaan <?= $input['perbedaan'] ?> seperti tersebut di atas. Adapun data yang benar dan dipakai seperti yang tercantum di Kartu Keluarga (KK). </td></tr>
