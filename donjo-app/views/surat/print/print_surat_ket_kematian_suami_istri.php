...
<table width="100%">
<tr><td width="30%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?= unpenetration($input['nama']); ?></td></tr>
<tr><td>Tempat/Tgl. Lahir</td><td>:</td><td><?= $input['tempat_lahir']; ?>, <?= tgl_indo(tgl_indo_in($input['tanggal_lahir'])); ?></td></tr>
<tr><td>Warganegara</td><td>:</td><td><?= $input['wn']; ?></td></tr>
