...
Kecamatan <?= $desa['nama_kecamatan']?> tanggal <?= $tanggal_kua; ?>, maka kami Camat <?= $desa['nama_kecamatan']?> </td></tr>
</table>
<div id="isi3">
<table width="100%">
<tr><td width="23%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?= $data_anggota['nama']; ?></td></tr>
...
<table><tr><td>Untuk melakukan pernikahan <?= $keterangan; ?></td></tr></table>
<table width="100%">
<tr><td width="23%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?= $nama_calon; ?></td></tr>
<tr><td>Tempat dan Tgl. Lahir</td><td>:</td><td><?= $tempat_lahir_calon; ?> <?= $tanggal_lahir_calon; ?></td></tr>
<tr><td>Pekerjaan</td><td>:</td><td><?= $pekerjaan_calon; ?></td></tr>
<tr><td>Alamat</td><td>:</td><td><?= $alamat_calon; ?></td></tr>
</table>
