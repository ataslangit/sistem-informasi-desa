...
<td class="indentasi">Yang bertanda tangan dibawah ini menerangkan dengan sesungguhnya bahwa:  </td></tr>
 ...
 <div id="isi2">
<table width="100%">
<tr><td width="30%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?= unpenetration($input['nama_ayah']); ?></td></tr>
<tr><td>Tempat/Tgl. Lahir</td><td>:</td><td><?= $input['tempat_lahir_ayah']; ?>, <?= tgl_indo(tgl_indo_in($input['tgl_lahir_ayah'])); ?></td></tr>
...
<tr><td>Tempat Tinggal</td><td>:</td><td><?= $input['tempat_tinggal_ayah']; ?></td></tr>
				<tr></tr>
				<tr></tr>
				<tr></tr>
<tr><td width="30%">Nama Lengkap</td><td width="3%">:</td><td width="64%"><?= unpenetration($input['nama_ibu']); ?></td></tr>
<tr><td>Tempat/Tgl. Lahir</td><td>:</td><td><?= $input['tempat_lahir_ibu']; ?>, <?= tgl_indo(tgl_indo_in($input['tgl_lahir_ibu'])); ?></td></tr>
...
<tr><td>Tempat Tinggal</td><td>:</td><td><?= $input['tempat_tinggal_ibu']; ?></td></tr>
</table>
   <table width="100%">
<tr></tr>
<tr></tr>
