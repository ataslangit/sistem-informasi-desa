...
<table width="100%">
<tr>
	<td width="10%">Lampiran</td><td>:</td><td width="43%" align="left"><?= $input['jml_lampiran'] ?> lembar </td>
...
<tr><td class="indentasi">Dengan ini kami memberitahukan bahwa akan dilangsungkan pernikahan antara <?= unpenetration($input['suami']) ?> dengan  <?= unpenetration($input['istri']) ?> pada hari  <?= $input['hari'] ?>, tanggal  <?= tgl_indo(tgl_indo_in($input['tanggal'])) ?> jam  <?= $input['jam'] ?> dengan maskawin berupa  <?= $input['mas_kawin'] ?> dibayar  <?= $input['tunai'] ?> bertempat di  <?= $input['tempat'] ?></td></tr>
<tr><td class="indentasi">Bersama ini kami lampirkan surat-surat yang diperlukan untuk diperiksa, sebagai berikut :</td></tr>
<tr><td><?= $input['lampiran1']?></td></tr>
<tr><td><?= $input['lampiran2']?></td></tr>
<tr><td><?= $input['lampiran3']?></td></tr>
<tr><td><?= $input['lampiran4']?></td></tr>
<tr><td><?= $input['lampiran5']?></td></tr>
<tr><td><?= $input['lampiran6']?></td></tr>
<tr><td><?= $input['lampiran7']?></td></tr>
<tr><td><?= $input['lampiran8']?></td></tr>
<tr></tr>
...
<tr></tr>
<tr></tr>
<tr><td align="center">__________________________</td><td ></td><td align="center">( <?= unpenetration($data['nama']) ?> )</td></tr>
<tr></tr>
<tr></tr>
<tr></tr>
<tr></tr>
