                    ...
                    <div class="ui-layout-center" id="maincontent">
                        ...
                        ?>
                            ...
                            if (is_array($peserta)) {
                                foreach ($peserta as $key => $item) {
                                    ...
                                    <tr>
                                        <td><?= $nomer; ?></td>
                                        <td><a
                                                href="<?= site_url('program_bantuan/peserta/' . $program[0]['sasaran'] . '/' . $item['nik'] . '/')?>"><?= $item['nama'] ?></a>
                                        </td>
                                        <td><?= $item['info']; ?></td>
                                    </tr>
                                    <?php
                            ...
                            <div style="padding:1em 0;">
                                <a class="uibutton"
                                    href="<?= site_url('program_bantuan/unduhsheet/' . $program[0]['id'] . '/')?>"><i
                                        class="icon icon-download"></i> Unduh dlm format .xls</a>
                            </div>
                        </div>
                    </div>
                </div>
