                                    ...
                                    <tr>
                                        ...
                                        <td style="width:120px;">
                                            <div class="uibutton-group">
                                                <a class="uibutton tipsy south" href="<?= site_url('program_bantuan/detail/' . $item['id'] . '/'); ?>" title="Detail"><span class="fa fa-list"></span> Detail</a>
                                                <a class="uibutton tipsy south" href="<?= site_url('program_bantuan/edit/' . $item['id'] . '/'); ?>" title="Ubah"><span class="fa fa-pencil"></span></a>
                                                <a class="uibutton tipsy south" href="<?= site_url('program_bantuan/hapus/' . $item['id'] . '/'); ?>" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash-o"></span></a>
                                            </div>
                                        </td>
