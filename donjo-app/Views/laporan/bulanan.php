                        ...
                        <div class="ui-layout-north panel top">
                            <div class="left">
                                <div class="uibutton-group">
                                    <a href="<?php echo site_url("laporan/cetak")?>" class="uibutton tipsy south" title="Cetak" target="_blank"><span class="fa fa-print">&nbsp;</span>Cetak</a>
                                    <a href="<?php echo site_url("laporan/excel")?>" class="uibutton tipsy south" title="Excel" target="_blank"><span class="fa fa-download">&nbsp;</span>Unduh</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td width="100%">
                                            <h3>LAPORAN PERKEMBANGAN PENDUDUK</h3>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" width="18%">
                                            <div align="center">PERINCIAN </div>
                                        </th>
                                            ...
                                            <div align="center">
                                                <table width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <th colspan="2" scope="col">
                                                                <div align="center">Warga Negara Indonesia </div>
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                            <th width="50%">
                                            ...
                                            <div align="center">
                                                <table width="100%">
                                                    <tbody>
                                                        <tr>
                                                            <th colspan="2" scope="col">
                                                                <div align="center">Orang Asing</div>
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                            <th width="50%">
