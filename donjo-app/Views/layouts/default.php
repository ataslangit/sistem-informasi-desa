...
<head>
    <title>
        ...
        Website Desa <?php echo unpenetration($desa['nama_desa']); ?>
    </title>
...
<body>
    <div id="maincontainer">
            ...
            <div class="innertube">
                <div id="header">
                    <div id="headercontent">
                        <div id="menu_vert">
                            <div id="menuwrapper">
                                <?= $this->include('partials/menu.tpl.php') ?>
                            </div>
                        </div>
                        <div id="menu_vert2">
                            <?php if (count($slide) > 0) {
                                echo $this->include('layouts/slide.php');
                            } ?>
                        </div>
                    </div>
                </div>
                ...
                <?php if (count($teks_berjalan) > 0) {
                    echo $this->include('layouts/teks_berjalan.php');
                } ?>

                <div id="mainmenu">
                    <?= $this->include('partials/menu.left.php') ?>
                </div>
        ...
        <div id="rightcolumn">
            <div class="innertube">
                <?= $this->include('partials/side.right.php') ?>
            </div>
        </div>
        <div id="footer">
            <?= $this->include('partials/copywright.tpl.php') ?>
        </div>
    </div>
</body>
