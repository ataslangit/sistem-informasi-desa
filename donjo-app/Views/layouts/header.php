...
<head>
    ...
    echo $single_artikel['judul'] . ' - ';
        ...
        <?= unpenetration($desa['nama_desa']); ?></title>
    ...
    <link href="<?= base_url('assets/front/css/first.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/css/ui-buttons.css') ?>" rel="stylesheet">
    <link href="<?= base_url('assets/front/css/colorbox.css') ?>" rel="stylesheet">
                    ...
                    <div id="divlogo-img">
                        <div class="intube">
                            <a href="<?= site_url('first') ?>">
                                <img src="<?= base_url('assets/files/logo/' . $desa['logo']) ?>"
                                    alt="<?= $desa['nama_desa']?>">
                            </a>
                        </div>
                    </div>
