                        ...
                        <div class="ui-layout-north panel">
                            <div class="left">
                                <div class="uibutton-group">
                                    <a href="<?= site_url("sms/form_anggota/{$grup['nama_grup']}") ?>" class="uibutton tipsy south" title="Tambah Data" target="ajax-modalx" rel="window" header="Tambah Anggota"><span class="fa fa-plus">&nbsp;</span>Tambah Anggota</a>
                                    <button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?= site_url("sms/delete_all_anggota/{$grup['nama_grup']}") ?>')" class="uibutton tipsy south"><span class="fa fa-trash-o">&nbsp;</span>Hapus Data
                                </div>
                            </div>
                        </div>
                        <div class="ui-layout-center" id="maincontent" style="padding: 5px;">
                            <div class="table-panel top">
                                <div class="right">
                                    ...
                                    <button type="button" onclick="$('#'+'mainform').attr('action','<?= site_url("sms/search_anggota/{$grup['nama_grup']}") ?>');$('#'+'mainform').submit();" class="uibutton tipsy south" title="Cari Data"><span class="fa fa-search">&nbsp;</span>Cari</button>
                                </div>
                            </div>
                            <table class="list">
                                <thead>
                                ...
                                <tbody>
                                    ...
                                    foreach ($main as $data) : ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?= site_url("sms/anggota_delete/{$data['nama_grup']}/{$data['id_kontak']}") ?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash-o"></span></a>
                                            </td>
