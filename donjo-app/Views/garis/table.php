                            ...
                            <table class="list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url("garis/form/{$p}/{$o}/{$data['id']}")?>" class="ui-icons icon-edit tipsy south" title="Edit Data"></a><a href="<?= site_url("garis/delete/{$p}/{$o}/{$data['id']}")?>" class="ui-icons icon-remove tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"></a><a href="<?= site_url("garis/ajax_garis_maps/{$p}/{$o}/{$data['id']}")?>" target="ajax-modalz" rel="window" header="garis <?= $data['nama']?>" class="ui-icons icon-maps tipsy south" title="garis <?= $data['nama']?>"></a>
                                        </td>
