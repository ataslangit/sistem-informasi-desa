...
<div class="themes bigfull">
    ...
    <div class='entry'>
        <p>
            ...
            <a class="group2" href="<?php echo base_url('assets/files/artikel/sedang_' . $single_artikel['gambar']) ?>" title="<?php echo $single_artikel['judul']?>"><img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/files/artikel/kecil_' . $single_artikel['gambar']) ?>"></a>
            <? }else{?>
            <img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/images/404-image-not-found.jpg') ?>">
            <? }?>
            <? }?>
            <?php echo $single_artikel['isi']?>
        </p>
    </div>
    <div class="entry" style="display:block;">
        ...
        <a class="group2" href="<?php echo base_url('assets/files/artikel/sedang_' . $single_artikel['gambar1']) ?>" title="<?php echo $single_artikel['judul']?>"><img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/files/artikel/kecil_' . $single_artikel['gambar1']) ?>"></a>
        <? }else{?>
        <img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/images/404-image-not-found.jpg') ?>">
        <? }?>
        <? }?>
        ...
        <a class="group2" href="<?php echo base_url('assets/files/artikel/sedang_' . $single_artikel['gambar2']) ?>" title="<?php echo $single_artikel['judul']?>"><img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/files/artikel/kecil_' . $single_artikel['gambar2']) ?>"></a>
        <? }else{?>
        <img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/images/404-image-not-found.jpg') ?>">
        <? }?>
        <? }?>
        ...
        <a class="group2" href="<?php echo base_url('assets/files/artikel/sedang_' . $single_artikel['gambar3']) ?>" title="<?php echo $single_artikel['judul']?>"><img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/files/artikel/kecil_' . $single_artikel['gambar3']) ?>"></a>
        <? }else{?>
        <img style="margin-right: 10px; margin-bottom: 5px; float: left;" src="<?php echo base_url('assets/images/404-image-not-found.jpg') ?>">
        <? }?>
        <? }?>
        ...
        <a href="<?php echo base_url('assets/files/dokumen/' . $single_artikel['dokumen']) ?>"><?php echo $single_artikel['link_dokumen']?></a>
        <? }?>
        <? }}?>
    </div>
