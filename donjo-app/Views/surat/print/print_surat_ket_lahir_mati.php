            ...
            <div>
                ...
                <table width="100%">
                    ...
                    <td class="indentasi">Yang bertanda tangan dibawah ini <?php echo unpenetration($input['jabatan'])?> <?php echo unpenetration($desa['nama_desa'])?>, Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?>,
                        Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?>, Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> menerangkan dengan sebenarnya bahwa seorang ibu: </td>
                    </tr>
                </table>
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td> <?php echo $input['hari']?>, <?php echo tgl_indo(tgl_indo_in($input['tanggal_mati']))?></td>
                        </tr>
                        <tr>
                            <td>di </td>
                            <td>:</td>
                    ...
                    <div id="isi3">
                        <table width="100%">
                            <tr>
                                <td colspan="3">telah lahir bayi dalam keadaan mati, setelah dikandungannya selama <?php echo $input['lama_kandungan']?> bulan </td>
                            </tr>
                            <tr>
