            ...
            <div>
                ...
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            <td class="indentasi" colspan="3">Bahwa yang tersebut namanya diatas, memang benar penduduk kami yang memiliki usaha <?php echo $input['usaha']?>, berlokasi di Dusun <?php echo unpenetration($data['dusun'])?>, Desa <?php echo unpenetration($desa['nama_desa'])?>, Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?>, Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?>.</td>
                        </tr>
                        <tr>
