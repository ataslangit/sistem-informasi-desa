            ...
            <div>
                ...
                <table width="100%">
                    ...
                    <td class="indentasi">Yang bertanda tangan dibawah ini <?php echo unpenetration($input['jabatan'])?> <?php echo unpenetration($desa['nama_desa'])?>, Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?>, Kabupaten
                        <?php echo unpenetration($desa['nama_kabupaten'])?>, Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> menerangkan bahwa: </td>
                    </tr>
                </table>
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            <td>Agama</td>
                            <td>:</td>
                            <td><?php echo $data['warganegara']?>/<?php echo $data['agama']?></td>
                        </tr>
                        <tr>
                            <td>Alamat</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo $input['hari']?>/<?php echo tgl_indo(tgl_indo_in($input['tanggal_mati']))?>/<?php echo $input['jam']?></td>
                        </tr>
                        <tr>
                            <td>Bertempat di</td>
                            <td>:</td>
                            <td><?php echo $input['tempat_mati']?></td>
                        </tr>
                        <tr>
                            <td>Penyebab Kematian</td>
                            <td>:</td>
                            <td><?php echo $input['sebab']?></td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                        <tr></tr>
                        ...
                        <tr>
                            <td>Nama</td>
                            <td>:</td>
                            <td><?php echo unpenetration($input['nama'])?></td>
                        </tr>
                        <tr>
                            <td>NIK</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Tgl Lahir/</td>
                            <td>:</td>
                            <td><?php echo tgl_indo(tgl_indo_in($input['tgl_lahir']))?></td>
                        </tr>
                        <tr>
                            <td>Pekerjaan</td>
                            <td>:</td>
