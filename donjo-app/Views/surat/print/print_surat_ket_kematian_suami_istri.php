                ...
                <div id="isi3">
                    <table width="100%">
                        <tr>
                            ...
                            <td width="3%">:</td>
                            <td width="64%"><?= unpenetration($input['nama']); ?></td>
                        </tr>
                        <tr>
                            <td>Tempat/Tgl. Lahir</td>
                            <td>:</td>
                            <td><?= $input['tempat_lahir']; ?>, <?= tgl_indo(tgl_indo_in($input['tanggal_lahir'])); ?></td>
                        </tr>
                        <tr>
                            <td>Warganegara</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?= $input['tempat_tinggal']; ?></td>
                        </tr>
                        <tr>
                            <td>telah meninggal dunia pada tanggal</td>
                            <td>:</td>
                            <td><?= tgl_indo(tgl_indo_in($input['tgl_meninggal'])); ?></td>
                        </tr>
                        <tr>
                            <td>di</td>
                            <td>:</td>
                            <td><?= $input['tempat_meninggal']; ?></td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr>
