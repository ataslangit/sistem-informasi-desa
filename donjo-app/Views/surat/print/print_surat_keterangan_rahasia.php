...
<body>
    <div id="content" class="container_12 clearfix">
        <div id="content-main" class="grid_7">
            ...
            <div>
                <table width="100%">
                    <tr> <img src="<?php echo base_url('assets/images/logo/' . $desa['logo']) ?>" alt="" width="100" height="80" class="logo"></tr>
                    ...
                    <div align="center"><u>
                            <h4 class="kop">SURAT KETERANGAN RAHASIA</h4>
                        </u></div>
                    <div align="center">
                        <h4 class="kop">Nomor : <?php echo $input['nomor']?></h4>
                    </div>
                </table>
                        ...
                        <td>
                            <table width="100%">
                                ...
                                <tr>
                                    <td>Keperluan </td>
                                    <td>:</td>
                                    <td> <?php echo $input['keperluan']?></td>
                                </tr>
                                <tr>
                                    <td>Berlaku mulai </td>
                                    <td>:</td>
