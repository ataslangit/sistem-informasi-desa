                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?= unpenetration(ununderscore($data['dusun']))?>, Rt. <?= $data['rt']?>, <?= unpenetration($desa['nama_desa'])?>, <?= unpenetration($desa['nama_kecamatan'])?>, <?= unpenetration($desa['nama_kabupaten'])?> tercatat dalam
                                No. KK: <?= $data['no_kk']?> dengan NIK: <?= $data['nik']?>, kepala keluarga : <?= unpenetration($data['kepala_kk'])?> menurut data kami tidak pernah terlibat perkara Polisi dan beradat istiadat baik </td>
                        </tr>
                        <tr>
                            <td>Keperluan </td>
                            <td>:</td>
                            <td> Sebagai pengantar untuk mendapatkan SKCK yang akan dipergunakan untuk <?= $input['keterangan']?></td>
                        </tr>
                    </table>
                    <table width="100%">
