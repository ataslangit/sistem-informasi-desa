            ...
            <div>
                ...
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            <td class="indentasi" colspan="3">Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?= unpenetration(ununderscore($data['dusun']))?>, Rt. <?= $data['rt']?>, <?= unpenetration($desa['nama_desa'])?>, <?= unpenetration($desa['nama_kecamatan'])?>, <?= unpenetration($desa['nama_kabupaten'])?> tercatat dalam
                                No. KK: <?= $data['no_kk']?> dengan NIK: <?= $data['nik']?>.</td>
                        </tr>
                        <tr>
                            <td class="indentasi" colspan="3">Orang tersebut telah datang kepada kami untuk melapor dan mengaku telah kehilangan <?= $input['barang']?>. </td>
                        </tr>
                        <tr>
                            <td>Rincian </td>
                            <td>:</td>
