                ...
                <div id="isi2">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?= $input['tempat_lahir_ayah']; ?>, <?= tgl_indo(tgl_indo_in($input['tgl_lahir_ayah'])); ?></td>
                        </tr>
                        <tr>
                            <td>Warganegara</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Pekerjaan</td>
                            <td>:</td>
                            <td><?= $input['pekerjaan_ayah']; ?></td>
                        </tr>
                        <tr>
                            <td>Tempat Tinggal</td>
                            <td>:</td>
                            <td><?= $input['tempat_tinggal_ayah']; ?></td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                        <tr></tr>
                        ...
                        <tr>
                            <td>Tempat/Tgl. Lahir</td>
                            <td>:</td>
                            <td><?= $input['tempat_lahir_ibu']; ?>, <?= tgl_indo(tgl_indo_in($input['tgl_lahir_ibu'])); ?></td>
                        </tr>
                        <tr>
                            <td>Warganegara</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Pekerjaan</td>
                            <td>:</td>
                            <td><?= $input['pekerjaan_ibu']; ?></td>
                        </tr>
                        <tr>
                            <td>Tempat Tinggal</td>
                            <td>:</td>
                            <td><?= $input['tempat_tinggal_ibu']; ?></td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr></tr>
