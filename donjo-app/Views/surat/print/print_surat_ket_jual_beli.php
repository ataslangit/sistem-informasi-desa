        ...
        <div id="content-main" class="grid_7">
            ...
            <div>
                ...
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo ($data['tempatlahir'])?>, <?php echo tgl_indo($data['tanggallahir'])?> (<?php echo $data['umur']?> Tahun)</td>
                        </tr>
                        <tr>
                            <td>Jenis Kelamin</td>
                            <td>:</td>
                        ...
                        <tr></tr>
                        <tr>
                            <td colspan="3">Yang bersangkutan hendak menjual <?php echo $input['barang']?>.
                                <?php echo $input['jenis']?> tersebut tidak dalam sengketa dengan pihak lain sehingga dapat dijual kepada pihak kedua yaitu:</td>
                            <td width="3%"></td>
                            <td width="64%"></td>
                        </tr>
                        <tr>
                ...
                <table width="100%">
                    ...
                    <tr>
                        <td width="23%" align="center">Ketua Adat <?php echo unpenetration($desa['nama_desa'])?></td>
                        <td width="30%"></td>
                    ...
                    <tr></tr>
                    <tr>
                        <td align="center">( <?php echo unpenetration($input['ketua_adat'])?> )
                        <td></td>
