<div id="pageC">
    ...
    echo $ch;
                    ...
                    <tr>
                        ...
                        <td><input name="nomor" type="text" class="inputbox number" size="5"
                                value="<?= $analisis_indikator['nomor']?>"></td>
                    </tr>
                    <tr>
                        <th>Pertanyaan</th>
                        <td><textarea name="pertanyaan"
                                style="resize:none;width:500px;height:80px;"><?= $analisis_indikator['pertanyaan']?></textarea>
                        </td>
                    </tr>
                    <tr class="delik">
                        <th>Bobot</th>
