                        ...
                        <div class="ui-layout-north panel">
                            <div class="left">
                                <div class="uibutton-group">
                                    <a href="<?php echo site_url('keluarga/form')?>" class="uibutton tipsy south" title="Tambah Data KK Baru"><span class="fa fa-plus">&nbsp;</span>Tambah KK Baru</a>

                                    <a href="<?php echo site_url('keluarga/form_old')?>" target="ajax-modal" rel="window" header="Tambah Data Keluarga" class="uibutton tipsy south" title="Tambah Data KK dari data penduduk yang sudah ter-input"><span class="fa fa-plus">&nbsp;</span>Tambah KK</a>
                                    ...
                                    <a href="<?php echo site_url("keluarga/cetak/$o")?>" target="_blank" class="uibutton tipsy south" title="Cetak"><span class="fa fa-print">&nbsp;</span>Cetak</a>
                                    ...
                                    <tr>
                                        ...
                                        <td width="5">
                                            <div class="uibutton-group">
                                                ...
                                                <a href="<?php echo site_url("keluarga/edit_nokk/$p/$o/$data[id]")?>" class="uibutton tipsy south" title="Ubah Data" target="ajax-modal" rel="window" header="Ubah Data KK"><span class="fa fa-pencil"></span></a>
