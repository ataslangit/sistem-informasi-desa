                        ...
                        <div class="ui-layout-north panel">
                            ...
                            <div class="left">
                                <div class="uibutton-group">
                                    <a href="<?= site_url('rtm/form_old')?>" target="ajax-modalx" rel="window" header="Tambah Data Rumah Tangga Per Penduduk" class="uibutton tipsy south" title="Tambah data dari penduduk"><span class="fa fa-plus">&nbsp;</span>Tambah Rumah Tangga</a>



                                    <?php if ($grup === 1) {?><button type="button" title="Hapus Data" onclick="deleteAllBox('mainform','<?= site_url("rtm/delete_all/{$p}/{$o}")?>')" class="uibutton tipsy south"><span class="fa fa-trash-o">&nbsp;</span>Hapus Data</button><?php }?>

                                    <a href="<?= site_url("rtm/cetak/{$o}")?>" target="_blank" class="uibutton tipsy south" title="Cetak"><span class="fa fa-print">&nbsp;</span>Cetak</a>

                                    <a href="<?= site_url("rtm/excel/{$o}")?>" target="_blank" class="uibutton tipsy south" title="Unduh"><span class="fa fa-download">&nbsp;</span>Unduh</a>
                                    <?php /*
            <a href="<?php echo site_url("rtm/excel_pbdt/$o")?>" target="_blank" class="uibutton special tipsy south" title="Unduh" ><span class="fa fa-download">&nbsp;</span>Excel PBDT</a>
                            ...
                            <div class="right">
                                <div class="uibutton-group">
                                    ...
                                    <button type="button" onclick="$('#'+'mainform').attr('action','<?= site_url('rtm/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south" title="Cari Data"><span class="fa fa-search">&nbsp;</span>Cari</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td width="5">
                                            <div class="uibutton-group">
                                                <a href="<?= site_url("rtm/anggota/{$p}/{$o}/{$data['id']}")?>" class="uibutton tipsy south" title="Rincian Anggota Rumah Tangga"><span class="fa fa-list"> Rincian </span></a>
                                                <?php if ($grup === 1) {?><a href="<?= site_url("rtm/edit_nokk/{$p}/{$o}/{$data['id']}")?>" target="ajax-modal" rel="window" header="Edit Rumah Tangga" class="uibutton tipsy south" title="Edit Data"><span class="fa fa-pencil"></span></a><a href="<?= site_url("rtm/delete/{$p}/{$o}/{$data['id']}")?>" class="uibutton tipsy south" title="Hapus Data" target="confirm" message="Apakah Anda yakin?" header="Hapus Data"><span class="fa fa-trash-o"></span> </a><?php } ?>
                                            </div>
                                        </td>
                    ...
                    <div class="ui-layout-south panel bottom">
                        ...
                        <div class="right">
                            ...
                            <div class="uibutton-group">
                                ...
                                <a href="<?= site_url("rtm/index/{$i}/{$o}")?>" <?php jecho($p, $i, "class='uibutton special'")?> class="uibutton"><?= $i?></a>
                                <?php endfor; ?>
                            </div>
                            <div class="uibutton-group">
                                <?php if ($paging->next): ?>
