                            ...
                            <table class="list">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="uibutton-group">
                                                <a href="<?= site_url("point/form/{$p}/{$o}/{$data['id']}")?>" class="uibutton tipsy south" title="Edit Data"><span class="fa fa-pencil"></span></a><a href="<?= site_url("point/delete/{$p}/{$o}/{$data['id']}")?>" class="uibutton tipsy south" title="Delete Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash-o"></span></a><?php if ($data['enabled'] === '2'):?><a href="<?= site_url('point/point_lock/' . $data['id'])?>" class="uibutton tipsy south" title="Enable point"><span class="fa fa-lock"></span></a><?php elseif ($data['enabled'] === '1'): ?><a href="<?= site_url('point/point_unlock/' . $data['id'])?>" class="uibutton tipsy south" title="Disable point"><span class="fa fa-unlock"></span></a><a href="<?= site_url("point/sub_point/{$data['id']}")?>" class="uibutton tipsy south" title="Rincian Sub point"><span class="fa fa-list"> Rincian </span></a><a href="<?= site_url("point/ajax_add_sub_point/{$data['id']}")?>" target="ajax-modal" rel="window" header="Tambah Sub point <?= $data['nama']?>" class="uibutton tipsy south" title="Tambah Sub point"><span class="fa fa-plus"></span></a>
                                                <?php endif?>
                                            </div>
                                        </td>
