                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?php echo unpenetration(ununderscore($data['dusun']))?>, Rt. <?php echo $data['rt']?>, <?php echo unpenetration($desa['nama_desa'])?>, <?php echo unpenetration($desa['nama_kecamatan'])?>, <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam
                                No. KK: <?php echo $data['no_kk']?> dengan NIK: <?php echo $data['nik']?>, kepala keluarga : <?php echo unpenetration($data['kepala_kk'])?> yang memiliki usaha <?php echo $input['usaha']?></td>
                        </tr>
                        <tr>
                            <td>Keperluan </td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Berlaku mulai </td>
                            <td>:</td>
                            <td><?php echo tgl_indo(tgl_indo_in($input['berlaku_dari']))?> sampai dengan <?php echo tgl_indo(tgl_indo_in($input['berlaku_sampai']))?></td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr></tr>
