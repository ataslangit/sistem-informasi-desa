        ...
        <div id="content-main" class="grid_7">
            ...
            <div>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td class="indentasi" colspan="3">Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?php echo unpenetration(ununderscore($data['dusun']))?>, Rt. <?php echo $data['rt']?>, <?php echo unpenetration($desa['nama_desa'])?>, <?php echo unpenetration($desa['nama_kecamatan'])?>, <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam
                                No. KK: <?php echo $data['no_kk']?> dengan NIK: <?php echo $data['nik']?>.</td>
                        </tr>
                        <tr>
                            <td class="indentasi" colspan="3">Orang tersebut telah datang kepada kami untuk melapor dan mengaku telah kehilangan <?php echo $input['barang']?>. </td>
                        </tr>
                        <tr>
                            <td>Rincian </td>
                            <td>:</td>
                            <td> <?php echo $input['rincian']?>. </td>
                        </tr>
                        <tr>
                            <td>Keterangan</td>
                            <td>:</td>
                ...
                <table width="100%">
                    ...
                    <tr></tr>
                    <tr>
                        <td align="center">( <?php echo $data['nama']?> )
                        <td></td>
