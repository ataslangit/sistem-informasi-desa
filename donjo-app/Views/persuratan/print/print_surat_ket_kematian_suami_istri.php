        ...
        <div id="content-main" class="grid_7">
            ...
            <div>
                <table width="100%">
                    ...
                    <div align="center"><u>
                            <h4 class="kop">SURAT KETERANGAN KEMATIAN SUAMI/ISTRI</h4>
                        </u></div>
                    <div align="center">
                ...
                <div id="isi3">
                    <table width="100%">
                        <tr>
                            ...
                            <td width="3%">:</td>
                            <td width="64%"><?php echo unpenetration($input['nama']); ?></td>
                        </tr>
                        <tr>
                            <td>Tempat/Tgl. Lahir</td>
                            <td>:</td>
                            <td><?php echo $input['tempat_lahir']; ?>, <?php echo tgl_indo(tgl_indo_in($input['tanggal_lahir'])); ?></td>
                        </tr>
                        <tr>
                            <td>Warganegara</td>
                            <td>:</td>
                            <td><?php echo $input['wn']; ?></td>
                        </tr>
                        <tr>
                            <td>Agama</td>
                            <td>:</td>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo $input['tempat_tinggal']; ?></td>
                        </tr>
                        <tr>
                            <td>telah meninggal dunia pada tanggal</td>
                            <td>:</td>
                            <td><?php echo tgl_indo(tgl_indo_in($input['tgl_meninggal'])); ?></td>
                        </tr>
                        <tr>
                            <td>di</td>
                            <td>:</td>
                            <td><?php echo $input['tempat_meninggal']; ?></td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr>
