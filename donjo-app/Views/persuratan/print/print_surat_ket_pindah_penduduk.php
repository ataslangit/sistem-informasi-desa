                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td class="indentasi">Yang bertanda tangan dibawah ini <?php echo unpenetration($pamong['jabatan'])?> <?php echo unpenetration($desa['nama_desa'])?>, Kecamatan <?php echo unpenetration($desa['nama_kecamatan'])?>,
                            Kabupaten <?php echo unpenetration($desa['nama_kabupaten'])?>, Provinsi <?php echo unpenetration($desa['nama_propinsi'])?> menerangkan bahwa: </td>
                    </tr>
                </table>
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo $pribadi['wn']?> / <?php echo $data['agama']?></td>
                        </tr>
                        <tr>
                            <td>Pekerjaan</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Alamat</td>
                            <td>:</td>
                            <td>RT. <?php echo $data['rt']?>, RW. <?php echo $data['rw']?>, Dusun <?php echo ununderscore(unpenetration($data['dusun']))?>, Desa <?php echo unpenetration($desa['nama_desa'])?>, Kec. <?php echo unpenetration($desa['nama_kecamatan'])?>, Kab. <?php echo unpenetration($desa['nama_kabupaten'])?></td>
                        </tr>
                        <tr>
                            <td>Alamat yang dituju</td>
                            <td>:</td>
                            <td>RT. <?php echo $input['rt_tujuan']?>, RW. <?php echo $input['rw_tujuan']?>, Kampung <?php echo $input['kampung_tujuan']?>, Dusun <?php echo ununderscore(unpenetration($input['dusun_tujuan']))?>, Desa <?php echo unpenetration($input['desa_tujuan'])?>, Kec. <?php echo unpenetration($input['kecamatan_tujuan'])?>, Kab. <?php echo unpenetration($input['kabupaten_tujuan'])?></td>
                        </tr>
                        <tr>
                            <td>Alasan </td>
                            <td>:</td>
                            <td> <?php echo $input['alasan']?></td>
                        </tr>
                        <tr>
...
?>
                    ...
                    <tr>
                        <table width="100%">
                            ...
                            <tr></tr>
                            <tr>
                                <td>Surat keterangan ini diterbitkan sebagai <?php echo $input['keterangan']?>.</td>
                            </tr>
                            <tr></tr>
                            <tr></tr>
                        ...
                        <table width="100%">
                            ...
                            <tr></tr>
                            <tr>
                                <td align="center">( <?php echo unpenetration($data['nama'])?> )
                                <td></td>
