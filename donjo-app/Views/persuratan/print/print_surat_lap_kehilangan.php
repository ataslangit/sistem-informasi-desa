        ...
        <div id="content-main" class="grid_7">
            ...
            <div>
                <table width="100%">
                    ...
                    <div align="center"><u>
                            <h4 class="kop">SURAT PENGANTAR LAPORAN KEHILANGAN</h4>
                        </u></div>
                    <div align="center">
                ...
                <div id="isi3">
                    <table width="100%">
                        ...
                        <tr>
                            <td>Keperluan </td>
                            <td>:</td>
                            <td> Sebagai pengantar untuk mendapatkan Surat Kehilangan yang akan dipergunakan untuk <?php echo $input['keperluan']?>. </td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr></tr>
