        ...
        <div id="content-main" class="grid_7">
            ...
            <div>
                <table width="100%">
                    ...
                    <div align="center"><u>
                            <h4 class="kop">PENGANTAR SURAT KETERANGAN CATATAN KEPOLISIAN</h4>
                        </u></div>
                    <div align="center">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>Bahwa orang tersebut adalah benar-benar warga kami yang bertempat tinggal di Dusun <?php echo unpenetration(ununderscore($data['dusun']))?>, Rt. <?php echo $data['rt']?>, <?php echo unpenetration($desa['nama_desa'])?>, <?php echo unpenetration($desa['nama_kecamatan'])?>, <?php echo unpenetration($desa['nama_kabupaten'])?> tercatat dalam
                                No. KK: <?php echo $data['no_kk']?> dengan NIK: <?php echo $data['nik']?>, kepala keluarga : <?php echo unpenetration($data['kepala_kk'])?> menurut data kami tidak pernah terlibat perkara Polisi dan beradat istiadat baik </td>
                        </tr>
                        <tr>
                            <td>Keperluan </td>
                            <td>:</td>
                            <td> Sebagai pengantar untuk mendapatkan SKCK yang akan dipergunakan untuk <?php echo $input['keterangan']?></td>
                        </tr>
                    </table>
                    <table width="100%">
