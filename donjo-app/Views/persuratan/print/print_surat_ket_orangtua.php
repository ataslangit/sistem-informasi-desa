        ...
        <div id="content-main" class="grid_7">
            ...
            <div>
                <table width="100%">
                    ...
                    <div align="center"><u>
                            <h4 class="kop">SURAT KETERANGAN TENTANG ORANG TUA</h4>
                        </u></div>
                    <div align="center">
                ...
                <div id="isi2">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td><?php echo $input['tempat_lahir_ayah']; ?>, <?php echo tgl_indo(tgl_indo_in($input['tgl_lahir_ayah'])); ?></td>
                        </tr>
                        <tr>
                            <td>Warganegara</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Pekerjaan</td>
                            <td>:</td>
                            <td><?php echo $input['pekerjaan_ayah']; ?></td>
                        </tr>
                        <tr>
                            <td>Tempat Tinggal</td>
                            <td>:</td>
                            <td><?php echo $input['tempat_tinggal_ayah']; ?></td>
                        </tr>
                        <tr></tr>
                        <tr></tr>
                        <tr></tr>
                        ...
                        <tr>
                            <td>Tempat/Tgl. Lahir</td>
                            <td>:</td>
                            <td><?php echo $input['tempat_lahir_ibu']; ?>, <?php echo tgl_indo(tgl_indo_in($input['tgl_lahir_ibu'])); ?></td>
                        </tr>
                        <tr>
                            <td>Warganegara</td>
                            <td>:</td>
                        ...
                        <tr>
                            <td>Pekerjaan</td>
                            <td>:</td>
                            <td><?php echo $input['pekerjaan_ibu']; ?></td>
                        </tr>
                        <tr>
                            <td>Tempat Tinggal</td>
                            <td>:</td>
                            <td><?php echo $input['tempat_tinggal_ibu']; ?></td>
                        </tr>
                    </table>
                    <table width="100%">
                        <tr></tr>
