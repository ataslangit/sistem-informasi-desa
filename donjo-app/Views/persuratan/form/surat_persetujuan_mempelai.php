    ...
    <table class="inner">
                    ...
                    <div id="sidecontent2" class="lmenu">
                        <ul>
                            ...
                            <li <?php if($data['url_surat']==$lap){?>class="selected" <?php }?>>
                                <a href="<?php echo site_url('persuratan/form/' . $data['url_surat']) ?>">
                            ...
                            <table class="form">
                                    ...
                                    <td>
                                        <select name="suami" class="inputbox ">
                                            ...
                                            <option value="<?php echo $data['id']?>">
                                                <font style="bold"> <?php echo $data['nama']?></font> -(<?php echo $data['nik']?>)
                                            </option>
                                            <?php }?>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td><input name="tempatlahir_suami" type="text" class="inputbox " size="30">
                                        <input name="tanggallahir_suami" type="text" class="inputbox datepicker" size="20">
                                    </td>
                                </tr>
                                <tr>
                                    <th>Warganegara</th>
        ...
        <tr>
            ...
            <td><input name="tempatlahir_istri" type="text" class="inputbox " size="30">
                <input name="tanggallahir_istri" type="text" class="inputbox datepicker" size="20">
            </td>
        </tr>
        <tr>
            <th>Warganegara</th>
...
<div class="ui-layout-south panel bottom">
    <div class="left">
        <a href="<?php echo site_url('persuratan') ?>" class="uibutton icon prev">Kembali</a>
    </div>
    <div class="right">
