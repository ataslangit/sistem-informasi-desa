            ...
            <div class="ui-layout-center" id="maincontent">
                ...
                <div class="table-panel top">
                    <div class="left">
                        ...
                        <a href="<?= site_url('analisis_respon/data_ajax')?>" class="uibutton special tipsy south" title="Fungsi Import harap digunakan secara seksama" target="ajax-modal" rel="window" header="Unduh Form Rujukan Import"><span class="fa fa-download">&nbsp;</span>Import</a>
                    </div>
                    <div class="right">
                        ...
                        <button type="button" onclick="$('#'+'mainform').attr('action','<?= site_url('analisis_respon/search')?>');$('#'+'mainform').submit();" class="uibutton tipsy south" title="Cari Data"><span class="fa fa-search">&nbsp;</span>Cari</button>
                    </div>
                </div>
                <table class="list">
                    <thead>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="uibutton-group">
                                    <a href="<?= site_url("analisis_respon/kuisioner/{$p}/{$o}/{$data['id']}")?>" class="uibutton south"><span class="fa fa-list"> Input Data</span></a>
                                </div>
                            </td>
                            <td><?= $data['nid']?></td>
                            <td><?= $data['nama']?></td>
