                        ...
                        <div class="ui-layout-north panel top">
                            <div class="left">
                                <div class="uibutton-group">
                                    <a href="<?= site_url("statistik/cetak/{$lap}") ?>" class="uibutton tipsy south" title="Cetak Data" target="_blank"><span class="fa fa-print">&nbsp;</span>Cetak Data</a>
                                    <a href="<?= site_url("statistik/excel/{$lap}") ?>" class="uibutton tipsy south" title="Unduh" target="_blank"><span class="fa fa-download">&nbsp;</span>Data Excel</a>
                                    <a href="<?= site_url("statistik/graph/{$lap}") ?>" class="uibutton tipsy south" title="Grafik"><span class="fa fa-bar-chart">&nbsp;</span>Grafik Data</a>
                                    <a href="<?= site_url("statistik/pie/{$lap}") ?>" class="uibutton tipsy south" title="Grafik"><span class="fa fa-pie-chart">&nbsp;</span>Pie Chart</a>
                                    <?php if ($lap === '13') { ?>
