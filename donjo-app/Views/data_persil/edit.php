                 ...
                 ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama"
                            placeholder="Tuliskan nama program" value="<?= $data['nama']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        Mulai <input type="text" class="inputbox required" style="width:200px" name="sdate" id="sdate"
                            placeholder="" value="<?= date('m/d/Y', strtotime($data['sdate'])); ?>">
                        s.d <input type="text" class="inputbox required" style="width:200px" name="edate" id="edate"
                            placeholder="" value="<?= date('m/d/Y', strtotime($data['edate'])); ?>">
                    </div>
