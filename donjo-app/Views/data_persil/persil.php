                        ...
                        <form id="mainform" name="mainform" action="" method="post">
                            <div class="left">
                                <input name="cari" id="cari" type="text" class="inputbox help tipped" size="20"
                                    ...
                                    onkeypress="if (event.keyCode == 13) {$('#'+'mainform').attr('action','<?= site_url('data_persil/search')?>');$('#'+'mainform').submit();}">
                                <button type="button"
                                    onclick="$('#'+'mainform').attr('action','<?= site_url('data_persil/search')?>');$('#'+'mainform').submit();"
...
if ($persil) {
		...
		';
			...
			<td><div class="uibutton-group">
					...
					<a class="uibutton tipsy south" href="' . site_url('data_persil/hapus/' . $item['id']) . '" title="Hapus Data" target="confirm" message="Apakah Anda Yakin?" header="Hapus Data"><span class="fa fa-trash-o"></span></a>
				</div></td>
